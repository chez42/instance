...
$languageStrings = array(
    ...
    'LBL_MASKED_FIELD_INPUT' => 'Masked Field Input',
    'LBL_ADD_FIELD' => 'Add New Field',
    ...
    'LBL_ACTIVE' => 'Active',
    'LBL_ALERT' => 'Alert',
    'LBL_IF_NOT_COMPLETED' => 'if not Completed?',
    'LBL_TEXT' => 'Text',
    'LBL_SYNTAX' => 'Syntax',
    'LBL_PLEASE_USE_VALUE_BELOW_TO_CREATE' => 'Please use the values below to create Custom Masked Input.',
    'LBL_REPRESENTS_ALPHA' => 'a - Represents an alpha character (A-Z, a-z)',
    'LBL_REPRESENTS_NUMERIC' => '9 - Represents a numeric character (0-9)',
    'LBL_REPRESENTS_ALPHANUMERIC' => '* - Represents an alphanumeric character (A-Z, a-z, 0-9)',
    'LBL_USE_OTHER_SYMBOLS' => 'You can use any other symbols - ( ) [ ] ! @ # % ^ & * ~ ... to accommodate your custom masked input needs. Symbols will show as is and letters & numbers will be replaced with your input.',

    /* For License page - Begin */
    'MODULE_LBL' => 'Masked Field Input',
