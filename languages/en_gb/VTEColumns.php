...
$languageStrings = array(
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'To enable multi column layouts, please go to the Module Layouts & Fields, you will then see option to select columns as well as configure field sequence.<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
