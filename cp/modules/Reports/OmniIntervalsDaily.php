...
echo '<input type="hidden" id="report_type" name="report_type" value="daily" />';
?>

<div class="m-section">
	<h1 class="m-section__heading">
		<i class="fa fa-bar-chart-o"style="color: #44b6ae!important;"></i>
		Omni Intervals Daily
	</h1>
</div>
                                        ...
                                        <table id="IntervalTable" border="1px solid black;" style="width:100%;">
                                            ...
                                            <?php foreach($data['INTERVALS'] as $v ){?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:right; padding:2px;">$<?php echo number_format($v['investmentreturn'],2,".",",");?></td>
                                                    <td style="text-align:right; padding:2px;" class="net_return" data-net_return='<?php echo number_format($v['net_return'],2,".",",");?>'><?php echo number_format($v['net_return'],2,".",",");?></td>
...
<script src="js/Reports/IntervalsDaily.js" type="text/javascript"></script>
