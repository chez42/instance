	...
	<div class="gridstack grid-stack" data-gs-width="12" >
        ...
        <?php if(!empty($CONSOLIDATED)){?>
    		<div data-gs-id="balance_history" id="balance_history" 
    			...
    			data-gs-width=<?php if($widgetsPosition['balance_history']['width'])echo $widgetsPosition['balance_history']['width'];else echo'1';?>
    			data-gs-height=<?php if($widgetsPosition['balance_history']['height'])echo $widgetsPosition['balance_history']['height'];else echo'3';?>
    	...
    	?>
        	<div data-gs-id="accounts" id="accounts" 
        		...
        		data-gs-width=<?php if($widgetsPosition['accounts']['width']) echo $widgetsPosition['accounts']['width'];else echo'1';?> 
        		data-gs-height=<?php if($widgetsPosition['accounts']['height'])echo $widgetsPosition['accounts']['height'];else echo'3';?> 
        		class="dashboardWidget grid-stack-item">
        		<div class='col-lg-12 grid-stack-item-content m-portlet' >
        			<h5 class="page-title">&nbsp;</h5>
		...
		<?php 
          ...
          ?>
    		<div data-gs-id="asset_allocation" id="asset_allocation" 
    			...
    			data-gs-width=<?php if($widgetsPosition['asset_allocation']['width'])echo $widgetsPosition['asset_allocation']['width'];else echo'1';?>
    			data-gs-height=<?php if($widgetsPosition['asset_allocation']['height'])echo $widgetsPosition['asset_allocation']['height'];else echo'3';?>
    			class="dashboardWidget grid-stack-item">
        		<div class='col-lg-12 grid-stack-item-content m-portlet'>
        			<h5 class="page-title">&nbsp;</h5>
