var IntervalsDaily_Js = {
    ...
    LineBarChart : function(){
        ...
        var data = new Array();
        $.post("includes/ReportData.php",{todo:'endvaluesdaily', account_numbers:accounts}, function(response){
        	
        	data = $.parseJSON(response);
            var chart = AmCharts.makeChart("chartdiv", {
                type: "stock",
                theme: "light",
                pathToImages: 'assets/global/plugins/amcharts/amstockcharts/images/',
                ...
                "export": {
                    libs: { "path": "assets/global/plugins/amcharts/amstockcharts/plugins/export/libs/" },
                    "enabled": true,
                    "menu": [ {
                        "class": "export-main",
                        "menu": [ {
...
jQuery(document).ready(function($) {
    IntervalsDaily_Js.registerEvents();
});