...
function get_reports($input_array){
	...
	if(!empty($account_numbers)) {
		...
		$query = "SELECT * FROM vtiger_portfolioinformation INNER JOIN vtiger_portfolioinformationcf ON 
...
function LoadIncomeLastYearReport($account_number){
...
function LoadOmniOverviewReport($account_number){
...
function LoadOmniProjectedReport($account_number){
	...
	$output["projected_income"] = $projected;
...
function LoadGHReport($input_array){
    ...
    if(!is_array($input_array['account_number']))
        $accounts = explode(",",$input_array['account_number']);
    else {
        $accounts = $input_array['account_number'];
    }
    $accounts = array_unique($accounts);
...
function LoadMonthOverMonth($account_number){
...
function LoadOmniIncome($account_number){
...
function LoadAssetClassReport($input_array){
    ...
    $overviewReportParams['account_number'] = $input_array['account_number'];
    $overviewReportParams['calling_module'] = "PortfolioInformation";
    $overviewReportParams['calling_record'] = $_SESSION['ID'];
...
function LoadGainLoss($account_number){
