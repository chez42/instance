...
/*modif5*/	var $_ad_password='';
	...
	function adLDAP($options=array()){
		...
		if ($this->_use_ssl){
			$this->_conn = ldap_connect("ldaps://".$dc) or die("Could not connect to LDAP SSL");
		} else {
			$this->_conn = ldap_connect($dc) or die("Could not connect to LDAP SSL");
		}
