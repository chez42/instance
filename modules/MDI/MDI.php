...
class MDI extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_mdi';
	var $table_index= 'mdiid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_mdicf', 'mdiid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mdi', 'vtiger_mdicf');
	...
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'title');
	...
	function getListViewSecurityParameter($module) {
		global $current_user;
		require('user_privileges/'.$GLOBALS['tenantGUID'].'/user_privileges_'.$current_user->id.'.php');
		require('user_privileges/'.$GLOBALS['tenantGUID'].'/sharing_privileges_'.$current_user->id.'.php');
