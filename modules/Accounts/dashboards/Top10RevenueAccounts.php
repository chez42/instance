...
class Accounts_Top10RevenueAccounts_Dashboard extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$headerFields = array('accountname' => "Account", 'annual_revenue' => "Revenue");
		...
		if(!empty($headerFields)){
			...
			$data = $moduleModel->getTopRevenueAccounts(array_keys($headerFields), $pageLimit);
