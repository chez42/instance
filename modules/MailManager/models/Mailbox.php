...
class MailManager_Mailbox_Model {
	...
	public function save() {
		...
		$sql = "";
		$parameters = array($this->username(), $this->server(), $this->username(), $this->password(false), $this->protocol(), $this->ssltype(), $this->certvalidate(), $this->refreshTimeOut(), $this->folder(), $this->smtpServer(), $currentUserModel->getId());
		...
		if ($isUpdate) {
            ...
            sent_folder=?, smtp_servername=? WHERE user_id=? AND account_id=?";
			$parameters[] = $this->mId;
		} else {
            ...
            mail_password, mail_protocol, ssltype, sslmeth, box_refresh,sent_folder, smtp_servername, user_id, 
