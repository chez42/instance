...
class ModSecurities_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if($currentUserModel->isAdminUser() && $recordModel->get('securitytype') == 'Mutual Fund') {
			$YFLinkModel = array(
				'linktype' => 'DETAILVIEWBASIC',
				'linklabel' => 'Sync From Yahoo Finance',
				'linkurl' => 'javascript:ModSecurities_Detail_Js.syncFromYahooFinance()',
				'linkicon' => ''
			);
			$linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues($YFLinkModel);
		}
