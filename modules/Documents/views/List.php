...
class Documents_List_View extends Vtiger_List_View {
	...
	public function DocTreeStructure(Vtiger_Request $request){
	    ...
	    $accessible_folders = $docFolderModel->getDocumentFolderWithParentList();
	    
	    $tree = $moduleModel->buildTree($accessible_folders);
	    
	    $html =  $moduleModel->nested2ul($tree);
	    
	    $viewer->assign('TREE',$html);
	...
	function getHeaderScripts(Vtiger_Request $request) {
	    ...
	    $jsFileNames = array(
	        ...
	        "modules.$moduleName.resources.DocumentsDragDrop",
