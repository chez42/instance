...
class QuotingTool_SettingRecord_Model extends Vtiger_Record_Model
{
    ...
    public function saveByTemplate($template_id, $data)
    {
        ...
        $columnNames = array("description", "label_decline", "label_accept", "background", "attachments", "template_id", "created", "updated", "expire_in_days", "success_content", "email_signed", "email_from_copy", "email_bcc_copy", "email_subject_copy", "email_body_copy", "ignore_border_email");
        $id = 0;
        if ($template_id) {
