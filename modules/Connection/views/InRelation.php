...
class Connection_InRelation_View extends Vtiger_RelatedList_View {
    ...
    function process(Vtiger_Request $request) {
        ...
        $contactFieldInfo = array();
        foreach ($contact_fields as $confieldName => $confieldModel) {
            $contactFieldInfo[$confieldName] = $confieldModel->getFieldInfo();
        }
		...
		return $viewer->view('ConnectionRelatedList.tpl', $relatedModuleName, 'true');
	}
