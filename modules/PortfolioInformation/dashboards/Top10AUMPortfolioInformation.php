...
class PortfolioInformation_Top10AUMPortfolioInformation_Dashboard extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$headerFields = array('contact_link' => "Name", 'account_number' => "Account No", 'total_value' => "AUM");
		...
		if(!empty($headerFields)){
			...
			$data = $moduleModel->getTop10AUMPortfolios(array_keys($headerFields));
