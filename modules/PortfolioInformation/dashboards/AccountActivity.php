...
class PortfolioInformation_AccountActivity_Dashboard extends Vtiger_IndexAjax_View {
...
//        $viewer->assign('DATA', $data);
        ...
        $viewer->assign("CHART_TYPE", 'account_activity');
...
#        $viewer->view('dashboards/Trailing12Revenue.tpl', $moduleName);
        ...
        if(!empty($content)) {
            ...
            $viewer->view('dashboards/AccountActivity.tpl', $moduleName);
        }
    }
    ...
    public function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array(
            ...
            "~/layouts/v7/modules/PortfolioInformation/resources/AjaxActivityChart.js",
            "~/layouts/v7/modules/PortfolioInformation/resources/AccountActivity.js"
        );
