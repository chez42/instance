...
class PortfolioInformation_RunTWRDebug_Action extends Vtiger_BasicAjax_Action{
    public function process(Vtiger_Request $request) {
		...
		echo "<strong>LAST QUARTER</strong><br />";
...
//            $warning = "*";    
		...
		echo "<strong>TRAILING 12</strong><br />";
