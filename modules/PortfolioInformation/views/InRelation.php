...
class PortfolioInformation_InRelation_View extends Vtiger_RelatedList_View {

/*    function process(Vtiger_Request $request) {
        $top = new PortfolioInformation_Reports_Model();
        $top->getDisplayValue($request);
    }*/
    ...
    function process(Vtiger_Request $request) {
        ...
        return $viewer->view('PortfolioRelatedList.tpl', 'PortfolioInformation', 'true');
    }
    
    public function getHeaderScripts(Vtiger_Request $request) {
        $moduleName = $request->getModule();
        $jsFileNames = array(
            "modules.Omnical.resources.ActivitiesGlobal",    
            "modules.OmniCal.resources.Activities", // . = delimiter
        );
