...
class PortfolioInformation_OmniProjected_View extends Vtiger_Index_View{
    ...
    ' . $graph_image . '
                ...
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/OmniProjectedPDF.tpl', $moduleName);
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/page_break.tpl', $moduleName);
...
#                $viewer->view('OmniOverview.tpl', "PortfolioInformation");
                $viewer->assign("SCRIPTS", $this->getHeaderScripts($request));
                $screen_content = $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/OmniProjected.tpl', "PortfolioInformation");
                echo $screen_content;
            }
        } else
    ...
    public function GeneratePDF($content, $logo = false, $calling_record){
        ...
        $stylesheet .= file_get_contents('layouts/vlayout/modules/PortfolioInformation/css/pdf/ProjectedPDF.css');
