...
class PortfolioInformation_GHXReport_View extends Vtiger_Index_View{
...
/*                $pdf_content = $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/TableOfContents.tpl', $moduleName);
                ...
                $pdf_content = $viewer->fetch('layouts/v7/modules/PortfolioInformation/pdf/GHXReportNewPDF.tpl', $moduleName);
                ...
                $screen_content .= $viewer->fetch('layouts/v7/modules/PortfolioInformation/GHXReportNew.tpl', "PortfolioInformation");
                echo $screen_content;
            }
        } else
...
//            "modules.$moduleName.resources.OmniOverview",
            ...
            "modules.$moduleName.resources.GHXReport",
        );
    ...
    public function getHeaderCss(Vtiger_Request $request) {
        ...
        $cssFileNames = array(
            '~/layouts/v7/modules/PortfolioInformation/css/GHXReportPDF.css',
            '~/layouts/v7/modules/PortfolioInformation/css/GHXReport.css',
