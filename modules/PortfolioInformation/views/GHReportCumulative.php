...
class PortfolioInformation_GHReportCumulative_View extends Vtiger_Index_View
{
...
####                $holdings_pie = PortfolioInformation_Reports_Model::AddPercentageTotalToPie($holdings_pie, $global_total);
            ...
            $ytd_performance->CalculateCombinedTWRCumulative($tmp_start_date, $tmp_end_date);
