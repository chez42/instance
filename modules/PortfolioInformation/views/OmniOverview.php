...
$pdf_content .= '<div class="graph_image" style="width:120mm; height:80mm; display:block; margin-left:auto; margin-right:auto; margin-top:10mm;">
    ' . $graph_image . '
</div>';
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/page_break.tpl', $moduleName);
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/OmniOverviewPDF.tpl', $moduleName);
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/page_break.tpl', $moduleName);
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/IndividualPerformance.tpl', $moduleName);
                $pdf_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/pdf/page_break.tpl', $moduleName);
...
#                $viewer->view('OmniOverview.tpl', "PortfolioInformation");
                $screen_content = $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/OmniOverview.tpl', "PortfolioInformation");
                $screen_content .= $viewer->fetch('layouts/vlayout/modules/PortfolioInformation/IndividualPerformance.tpl', "PortfolioInformation");
                echo $screen_content;
            }
        } else
