...
function insertIntoRecurringTable(& $recurObj)
{
	...
	if($flag=="true") {
		...
		$recurring_insert = "insert into vtiger_recurringevents(recurringid, activityid, recurringdate, recurringtype, recurringfreq, recurringinfo, recurringenddate) values (?,?,?,?,?,?,?)";
