...
class Calendar_ListView_Model extends Vtiger_ListView_Model {
	...
	function getQuery() {
		...
		$queryGenerator->addCondition('activitytype','Emails,Task','n','AND');
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks[] = array(
				...
				'linkurl' => 'javascript:Calendar_List_Js.triggerCalendarMassEdit("index.php?module='.$moduleModel->get('name').'&view=MassActionAjax&mode=showMassEditForm");',
				'linkicon' => ''
			);
			$massActionLinks[] = array(
				'linktype' => 'LISTVIEWMASSACTION',
				'linklabel' => 'LBL_CHANGE_STATUS',
				'linkurl' => 'javascript:Calendar_List_Js.triggerCalendarMassEdit("index.php?module='.$moduleModel->get('name').'&view=MassActionAjax&mode=showChangeStatusForm");',
				'linkicon' => ''
			);
		}
	if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks = array(
				array(
					'linktype' => 'LISTVIEWMASSACTION',
					'linklabel' => 'LBL_EDIT',
					'linkurl' => 'javascript:Calendar_List_Js.triggerMassEdit("index.php?module=Events&view=MassActionAjax&mode=showMassEditForm");',
					'linkicon' => ''
				)
			);
		}
