...
class Reports_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams='') {
		...
		$reportType = $recordModel->get('reporttype');
		...
		if($reportType != 'chart') {
		    ...
		    if($currentUserModel->hasModulePermission($emailModuleModel->getId())) {
		        $detailViewLinks[] = array(
		            'linklabel' => vtranslate('LBL_SEND_EMAIL', $moduleName),
		            'linkurl' => 'javascript:Vtiger_Detail_Js.triggerSendEmail("index.php?module='.$moduleName.
