...
class Reports_Record_Model extends Vtiger_Record_Model {
	...
	function getScheduleReportSQL($advancedFilterSQL=false, $format=false) {
	    $reportRun = ReportRun::getInstance($this->getId());
	    $sql = $reportRun->sGetSQLforScheduleReport($this->getId(), $advancedFilterSQL, $format);
	    return $sql;
	}
}