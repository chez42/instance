...
class RingCentral_InRelation_View extends Vtiger_RelatedList_View {
    ...
    function process(Vtiger_Request $request) {
        ...
        $relationListView = RingCentral_RelationListView_Model::getInstance($parentRecordModel, $relatedModuleName, $label);
