...
class HelpDesk_Module_Model extends Vtiger_Module_Model {
	...
	public function saveRecord(Vtiger_Record_Model $recordModel) {
		...
		$view_permission = $recordModel->get('view_permission');
		
		$view_permission = implode(" |##| ", $view_permission);
		
		$recordModel->set('view_permission', $view_permission);
	...
	public function getNonAdminAccessControlQueryForRelation($relatedModuleName) {
	    if ($relatedModuleName == 'Documents') {
	        ...
	        return $instance->getNonAdminAccessControlQuery($relatedModuleName,$currentUser);
	    } else
	        return parent::getNonAdminAccessControlQueryForRelation($relatedModuleName);
	}
