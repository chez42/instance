...
class Settings_CronTasks_Record_Model extends Settings_Vtiger_Record_Model {
    ...
    /**
     * Reset the last start/end time
     * @return string
     */
    public function getResetUrl(){
        return 'module=CronTasks&parent=Settings&view=ResetTask&record='.$this->getId();
    }
	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
			...
			array(
                'linktype' => 'LISTVIEWRECORD',
                'linklabel' => 'Reset Last Scan',
                'linkurl' => "javascript:Settings_CronTasks_List_Js.triggerEditEvent('".$this->getResetUrl()."')",
                'linkicon' => 'icon-trash'
            )
		);
