 ...
 * Time: 4:38 PM
 */
class Settings_PortfolioInformation_Administration_Action extends Vtiger_BasicAjax_Action{
    public function process(Vtiger_Request $request){
        ...
        switch($todo){
            ...
            case "UpdateSchwabMappingField":
                Settings_PortfolioInformation_Administration_Model::UpdateSchwabMappingField($id, $field, $value);
                break;
