...
/****************************** 09-Aug-2018 Changes *************************************/
		...
		$fieldInfo['isRelateListView'] = $this->isRelateListViewEnabled();
		$fieldInfo['isRelateListViewDisabled'] = $this->isRelatedTabViewOptionDisabled();
...
/****************************** 09-Aug-2018 Changes *************************************/
	...
	public function isRelatedTabViewOptionDisabled() {
	    
	    $complusoryMandatoryFieldList = $this->getCumplosoryMandatoryFieldList();
	...
	public function getCumplosoryMandatoryFieldList() {
	    ...
	    $compulsoryRelatedTabFields = $focus->related_tab_fields;
	    
	    if(empty($compulsoryRelatedTabFields)) {
	        $compulsoryRelatedTabFields = array();
	    }
	    
	    return $compulsoryRelatedTabFields;
	}
