...
class Vtiger_Relation_Model extends Vtiger_Base_Model{
	...
	public function getListUrl($parentRecordModel) {
	    ...
	    if($this->get('modulename') == 'Documents' && $current_user->documents_default_view == 'FolderView')
		...
		'&view=Detail&record='.$parentRecordModel->getId().'&mode='.$mode.'&relationId='.$this->get('relation_id');
	}
