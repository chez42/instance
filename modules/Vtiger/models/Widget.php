...
class Vtiger_Widget_Model extends Vtiger_Base_Model {
	...
	public function getWidth() {
		$largerSizedWidgets = array('GroupedBySalesPerson', 'PipelinedAmountPerSalesPerson', 'GroupedBySalesStage', 'Funnel Amount','PopulationPyramid');//12.07.2019 population pyramid 
		$title = $this->getName();
	...
	public function getHeight() {
		...
		if($title == 'PopulationPyramid') { //12.07.2019 population pyramid 
		    $this->set('height', '2');
		}
