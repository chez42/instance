...
class Potentials_Module_Model extends Vtiger_Module_Model {
    ...
    public function getRecentTasks($mode, $pagingModel, $user, $recordId = false){
        ...
        $query = "SELECT vtiger_crmentity.crmid, vtiger_crmentity.smownerid, vtiger_crmentity.setype,
				vtiger_task.* FROM vtiger_task INNER JOIN vtiger_crmentity ON
				vtiger_crmentity.crmid = vtiger_task.taskid INNER JOIN
				 vtiger_potential ON vtiger_potential.potentialid = vtiger_task.parent_id
