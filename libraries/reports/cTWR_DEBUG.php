...
//                    $last_value = $current_value;
                ...
                /*
                 * THIS IF ELSE IS NEW... THERE IS A PROBLEM IF THE ACCOUNT IS LESS THAN A YEAR OLD.  REFERENCE ACCOUNT A THE TIME OF THIS NOTE IS: https://crm.concertadvisorservices.com/index.php?module=Accounts&view=Detail&record=1523086&mode=showDetailViewByMode&requestMode=summary&tab_label=Household%20Summary
                 * PID:  52306
                 * http://crmstage/vcrm2/index.php?module=PortfolioInformation&action=RunTWR&pids=52306
                 * You're welcome for not making you search out that PID
                 * Account number is: 676-247128
                 * You're welcome again
                 */
                if($dbz == 0){
                    $t = 0;//( $current_value - $ends[$k] - $last_value) / $dbz;
                    $dbz = 1;
                }
                else
...
///            echo "Not Annualized: {$sdate} - {$edate}<br />";
        ...
        echo "<br />ABOUT TO SUBTRACT -- " . $return . " = " . $return . "-1<br /><br />";
        $return = $return-1;
        $return *= 100;
