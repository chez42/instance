...
class cFidelityPortfolioData{
    ...
    public function __construct($data){
        ...
        $this->account_number = $data['balance']['account_number'];
        ...
        $this->net_worth = $data['personal']['net_worth'];
...
class cFidelityPortfolios extends cCustodian {
    ...
    protected function UpdatePortfolios(cFidelityPortfolioData $data){
        ...
        $query = "UPDATE vtiger_portfolioinformation p 
                  ...
                  LEFT JOIN  {$this->database}.portfolios_mapping_fidelity pmap ON pmap.fidelity_type = pf.registration
                  SET cf.description = f.primary_account_owner, p.first_name = f.primary_owner_first_name, 
                    ...
                    p.total_value=f.net_worth, cf.stated_value_date = f.as_of_date, cf.securities = f.net_worth - f.cash_available_to_withdraw, \" +
