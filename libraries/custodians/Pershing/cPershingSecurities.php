 ...
 */
class cPershingSecurities extends cCustodian {
    private $securities_data;//Holds the security information

    public function __construct($name = "Pershing", $database = "custodian_omniscient", $module = "securities",
                                $securities_table="custodian_securities_pershing"){
        $this->name = $name;
