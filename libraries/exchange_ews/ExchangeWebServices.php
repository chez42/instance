 ...
 * @package php-ews
 */
include_once('libraries/exchange_ews/ExchangeServices.php');
include_once('libraries/exchange_ews/NTLMSoapClient/Exchange.php');
...
class ExchangeWebServices
{
    ...
    protected function initializeSoapClient()
    {
        $this->soap = new NTLMSoapClient_Exchange(
            'libraries/exchange_ews/wsdl/services.wsdl',
            array(
                'user' => $this->username,
