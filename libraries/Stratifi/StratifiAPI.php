...
//        $body = '{ "positions": [ { "ticker": "CASH", "value": 4.3 }, { "ticker": "ISFCX", "value": 42.22 }, { "ticker": "LCEVX", "value": 46.83 }, { "ticker": "AHHYX", "value": 6.65 } ] }';
    ...
    public function GetStratifiLinkingInformation($account_number){
        global $adb;
        $query = "SELECT cf.stratid AS account_stratid, ccf.stratid AS contact_stratid, acf.stratid AS household_stratid, u.stratid AS advisor_stratid, e.smownerid AS omni_advisor_id
