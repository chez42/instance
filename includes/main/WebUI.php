	...
	function process (Vtiger_Request $request) {
		...
		try {
			...
			if ($handler) {
				...
				// Added Patch to allow ModComments List View By Devi Techno Solutions
			...
			if ($view && !(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest')) {
				...
				$handlerClass = Vtiger_Loader::getComponentClassName('View', 'PermissionDenied', $qualifiedModuleName);
