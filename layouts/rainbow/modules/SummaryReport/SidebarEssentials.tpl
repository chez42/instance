		...
		<div class="module-filters" id="module-filters">
			<div class="sidebar-container lists-menu-container">
				<div class="sidebar-header clearfix">
					...
					<button id="createFilter" onclick='Reports_List_Js.triggerAddFolder("index.php?module=Reports&view=EditFolder");' class="btn btn-info pull-right sidebar-btn" title="{vtranslate('LBL_ADD_NEW_FOLDER', $MODULE)}">
				...
				<div class="menu-scroller mCustomScrollBox" data-mcs-theme="dark">
					<div class="mCustomScrollBox mCS-light-2 mCSB_inside" tabindex="0">
						<div class="mCSB_container" style="position:relative; top:0; left:0;">
							<div class="list-menu-content" style="height: 100%!important;">
								<div class="list-group">
									<ul class="lists-menu">
										<li style="font-size:12px;" class="listViewFilter" >
											<a href="#" class='filterName' data-filter-id="All"><i class="ti-folder foldericon"></i>&nbsp;{vtranslate('LBL_ALL_REPORTS', $MODULE)}</a>
										</li>
										{foreach item=FOLDER from=$FOLDERS name="folderview"}
											<li style="font-size:12px;" class="listViewFilter {*if $smarty.foreach.folderview.iteration gt 5} filterHidden hide{/if*}" >
												...
												<a href="#" class='filterName' data-filter-id={$FOLDER->getId()}><i class="ti-folder foldericon"></i>&nbsp;{if {$VIEWNAME|strlen > 50} }{$VIEWNAME|substr:0:45}..{else}{$VIEWNAME}{/if}</a> 
												<div class="pull-right">
													{assign var="FOLDERID" value=$FOLDER->get('folderid')}
													<span class="js-popover-container">
														<span class="ti-angle-down" data-id="{$FOLDERID}" data-deletable="true" data-editable="true" rel="popover" data-toggle="popover" data-deleteurl="{$FOLDER->getDeleteUrl()}" data-editurl="{$FOLDER->getEditUrl()}" data-toggle="dropdown" aria-expanded="true"></span>
													</span>
												</div>
											</li>
										{/foreach}
										<li style="font-size:12px;" class="listViewFilter" >
											<a href="#" class='filterName' data-filter-id="shared"><i class="ti-folder foldericon"></i>&nbsp;{vtranslate('LBL_SHARED_REPORTS', $MODULE)}</a>
										</li>
									</ul>
									...
									<div id="filterActionPopoverHtml">
										<ul class="listmenu hide" role="menu">
											<li role="presentation" class="editFilter">
												<a role="menuitem"><i class="ti-pencil-alt"></i>&nbsp;{vtranslate('LBL_EDIT',$MODULE)}</a>
											</li>
