...
{strip}
	...
	<td style="text-align:center;">
		<i class="ti-trash deleteRow cursorPointer" title="{vtranslate('LBL_DELETE',$MODULE)}"></i>
				...
				<div class="row">
					<div class="col-lg-10">
						<div class="input-group" style="width:100%">
							...
							<div class="col-lg-2">
								{if $row_no eq 0}
									<i class="lineItemPopup cursorPointer ti-services" data-popup="ServicesPopup" title="{vtranslate('Services',$MODULE)}" data-module-name="Services" data-field-name="serviceid"></i>
									<i class="lineItemPopup cursorPointer ti-products" data-popup="ProductsPopup" title="{vtranslate('Products',$MODULE)}" data-module-name="Products" data-field-name="productid"></i>
								{elseif $entityType eq '' and $PRODUCT_ACTIVE eq 'true'}
									<i class="lineItemPopup cursorPointer ti-products" data-popup="ProductsPopup" data-module-name="Products" title="{vtranslate('Products',$MODULE)}" data-field-name="productid"></i>
								{elseif $entityType eq '' and $SERVICE_ACTIVE eq 'true'}
									<i class="lineItemPopup cursorPointer ti-services" data-popup="ServicesPopup" data-module-name="Services" title="{vtranslate('Services',$MODULE)}" data-field-name="serviceid" ></i>
								{else}
		...
		<td>
			<div>
				...
				{if $PRICEBOOK_MODULE_MODEL->isPermitted('DetailView') && $MODULE != 'PurchaseOrder'}
					<i class="priceBookPopup cursorPointer ti-pricebooks" data-popup="Popup" data-module-name="PriceBooks" style="float:left"></i>
				{/if}
			</div>
