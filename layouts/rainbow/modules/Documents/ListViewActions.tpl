...
{strip}
    ...
    <div id="listview-actions" class="listview-actions-container">
        {foreach item=LIST_MASSACTION from=$LISTVIEW_MASSACTIONS name=massActions}
            ...
            {else if $LIST_MASSACTION->getLabel() eq 'LBL_ADD_FOLDER'}
                {assign var=folderAction value=$LIST_MASSACTION}
            {else}
        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                ...
                {/if}
                {*if $folderAction}
                    <a type="button" class="btn btn-default" id="{$MODULE}_listView_massAction_{$folderAction->getLabel()}" 
                            onclick="{$folderAction->getUrl()}" title="{vtranslate('LBL_ADD_FOLDER', $MODULE)}" >
                             ...
                             {/if}
                                ...
                                {foreach item="CUSTOM_VIEW" from=$GROUP_CUSTOM_VIEWS name="customView"}
                                    ...
                                    <li class="{if $VIEWID eq $CUSTOM_VIEW->getId() && ($CURRENT_TAG eq '')} active {/if}" style="display: block !important">
				                        ...
				                        <a class="deleteFilter" title="{vtranslate('LBL_DELETE', $MODULE)}" data-url="{$CUSTOME_VIEW_RECORD_MODEL->getDeleteUrl()}"  >
				                        	<i class="material-icons text-danger">delete</i>
										</a>
										<a class="duplicateFilter" title="{vtranslate('LBL_DUPLICATE', $MODULE)}" data-url="{$CUSTOME_VIEW_RECORD_MODEL->getDuplicateUrl()}"  >
				                        	<i class="material-icons text-info">content_copy</i>
										</a>
										<a class="toggleDefault" title="{vtranslate('LBL_DEFAULT', $MODULE)}"   data-url="{$CUSTOME_VIEW_RECORD_MODEL->getToggleDefaultUrl()}"  >
