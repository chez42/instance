                    ...
                    {foreach item=RELATED_LINK from=$RELATED_LIST_LINKS['LISTVIEWBASIC']}
						...
						{if $RELATED_LINK->get('linkmodule') eq 'Documents'}
                            <div class="col-sm-3">
                                ...
                                {/if}
                                <button type="button" module="{$RELATED_MODULE_NAME}"  class="btn addButton btn-primary
                    ...
                    {if $IS_CREATE_PERMITTED}
						<div class="col-sm-3">
							<button type="button" class="btn btn-primary uploadDocUppy">
								<span title="{vtranslate('Bulk Upload', $MODULE)}"><i class="material-icons">file_upload</i></span>&nbsp;{vtranslate('Bulk Upload', $RELATED_MODULE_NAME)}
							</button>
                ...
                <tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
                    ...
                    <td class="textOverflowEllipsis" style="width:120px!important">
                        ...
                        <span class="actionImages">
                            ...
                            {if $IS_DELETABLE}
                            <a class="relationDelete"><i title="{vtranslate('LBL_UNLINK', $MODULE)}" class="material-icons">link</i></a>&nbsp;
                            {/if}
							...
							{if $DOCUMENT_RECORD_MODEL->get('filename') && $DOCUMENT_RECORD_MODEL->get('filestatus')}
								<a name="viewfile" href="javascript:void(0)" data-filelocationtype="{$DOCUMENT_RECORD_MODEL->get('filelocationtype')}" data-filename="{$DOCUMENT_RECORD_MODEL->get('filename')}" onclick="Vtiger_Header_Js.previewFile(event)"><i title="{vtranslate('LBL_VIEW_FILE', $RELATED_MODULE_NAME)}" class="material-icons alignMiddle">image</i></a>&nbsp;
							{/if}
