			...
			<div class="col-xs-3 col-lg-5 col-md-5 col-sm-5 module-breadcrumb-{$smarty.request.view}" style="margin:  0px; padding: 0px;">
 				...
 				<div id="appnav" class="navbar-right">
					<div class="btn-group">
						...
						{* 
						<button id="{$MODULE}_listView_basicAction_MailConverter" type="button" class="btn module-buttons addMailConverter"
							...
							<i class="material-icons">add</i>
							<span class="hidden-sm hidden-xs">Configure Mailbox</span>
						</button>*}
					</div>
				</div>
			</div>
