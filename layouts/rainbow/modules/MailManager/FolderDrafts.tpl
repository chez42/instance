...
{strip}
    ...
    <div class='col-lg-12 padding0px'>
        ...
        <div class="col-lg-9 mmSearchContainer">
            <div>
                ...
                <div class="col-lg-4 padding0px mmSearchDropDown" style="margin-top:-40px !important;margin-left:67% !important;">
    ...
    {if $FOLDER->mails()}
        <div class="col-lg-12 mmEmailContainerDiv padding0px" id='emailListDiv'>
