...
Vtiger.Class("Control_Layout_Fields_Js",{
                            ...
                            if(blockid > 0){
                                                    ...
                                                    jQuery.each(actions, function (index, value) {
                                                        ...
                                                        if (value.option == 'hide') {
                                                            if(!is_block) {
                                                                ...
                                                                form_element.addClass(condition_key+'-clf-hide');
                                                                target_td.children().hide();
                                                                target_td.prev('.fieldLabel').attr("data-label",target_td.prev('.fieldLabel').html())
                                                                target_td.prev('.fieldLabel').html('');
                                                            }
                                                        }
                                                        ...
                                                        if(form_element.length > 0){
                                                            ...
                                                            if(form_element.hasClass(condition_key+'-clf-mandatory')){
                                                                ...
                                                                if(!is_block) {
                                                                    ...
                                                                    form_element.show();
                                                                    target_td.children().show();
                                                                    target_td.prev('.fieldLabel').html( target_td.prev('.fieldLabel').data('label'));
                                                                }
                                                            }
                                ...
                                if(check_condition){
                                    jQuery.each(actions,function(key,value){
                                        ...
                                        var data_info = form_element.data('fieldname');
                                        var this_td = form_element.closest('.fieldValue');
                                        if(value.option == 'mandatory'){
                                            this_td.show();
                                            this_td.prev().show();
                                            form_element.attr('data-rule-required','true');
                                            form_element.addClass(condition_key+'-clf-mandatory');
                                            var field_label = this_td.prev();
                                            if(!field_label.find('span').length) field_label.append('<span class="redColor vt-m">*</span>');
                                        }else if(value.option == 'read_only'){
                                            this_td.show();
                                            this_td.prev().show();
                                            form_element.attr('readonly','readonly');
                                            ...
                                            this_td.hide();
                                            this_td.prev().hide();
                                            var this_tr = this_td.closest('.row');
                                    ...
                                    jQuery.each(actions,function(key,value){
                                        ...
                                        if(form_element.hasClass(condition_key+'-clf-mandatory')){
                                            ...
                                            form_element.removeClass(condition_key+'-clf-mandatory');
                                            var field_label = this_td.prev();
                                            field_label.find('span.vt-m').remove();
                                        }
    ...
    hideTr:function(this_tr){
        var count_td_hide = 1;
        this_tr.find('div:not(.clearfix)').each (function() {
                        ...
                        jQuery.each(data.clf_info,function(k,v) {
                            ...
                            if(blockid > 0){
                                    ...
                                    jQuery.each(actions, function (index, value) {
                                        ...
                                        if (typeof requestMode != 'undefined' && requestMode == 'full') {
                                            ...
                                            if (value.option == 'hide') {
                                                target_td.prev().html("");
                                                target_td.html("");
                                                var tr = target_td.closest('.row');
                                                var table = tr.closest('.table');
                                                var empty_tr = true;
                                                var count_item = 0;
                                                var saved_td = [];
                                                jQuery.each(tr.find('div'), function () {
                                                    count_item++;
                                            ...
                                            if(target_td.length == 0){
                                                ...
                                                if (value.option == 'hide') {
                                                    ...
                                                    //var parent_tr = target_element.closest('.summaryViewEntries');
                                                    //if(parent_tr.find('div').length < 4){
                                                    //    target_span.closest('.row').remove();
                                                    //}
                                                }
                                                else if (value.option == 'read_only') {
                                ...
                                jQuery.each(jQuery('#detailView').find('.detailview-table'), function () {
                                    var row_count = jQuery(this).find('.row').length;
                ...
                if(err === null) {
                    if(!jQuery.isEmptyObject(data)){
                        ...
                        jQuery.each(data.clf_info,function(k,v){
                            ...
                            var actions = v.actions;
                            var condition_key = k;
                            var check_condition = thisInstance.checkConditionToButtonPopupForm(all_condition,any_condition,field_name_changed,'',role_id,new_value);
                            if(check_condition){
                                jQuery.each(actions,function(key,value){
                                    var field_name_action = value.field;
...
jQuery(document).ready(function(){
    ...
    if(view == 'Detail' && ((vtetabs.length == 0  && relatedBlocksLists.length == 0) || ( vtetabs.length == 1 && vtetabdonotworking ) || ( relatedBlocksLists.length == 1 && vterbldonotworking ))){
        var url = window.location.href.split('?');
