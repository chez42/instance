...
{strip}
    ...
    <script type="text/javascript" src="{vresource_url('layouts/rainbow/modules/Vtiger/resources/Vtiger.js')}"></script>
   ...
   <script type='text/javascript' src='layouts/v7/lib/jquery/waitMe/waitMe.min.js'></script>
       <script type="text/javascript" src="layouts/v7/lib/slick/slick.js"></script>
   
    {foreach key=index item=jsModel from=$SCRIPTS}
    	{if vresource_url($jsModel->getSrc()) EQ 'layouts/v7/modules/CustomFormsViews/resources/CustomFormsViews.js?v=7.1.0'}
    	<script type="{$jsModel->getType()}" src="layouts/rainbow/modules/CustomFormsViews/resources/CustomFormsViews.js?v=7.1.0"></script>
    	{elseif vresource_url($jsModel->getSrc()) EQ 'layouts/v7/modules/ControlLayoutFields/resources/ControlLayoutFields.js?v=7.1.0'}
    	<script type="{$jsModel->getType()}" src="layouts/rainbow/modules/ControlLayoutFields/resources/ControlLayoutFields.js?v=7.1.0"></script>
    	{else}
...
parent.addEventListener("resize", function() {
    ...
    <script type="text/javascript" src="layouts/rainbow/modules/Vtiger/resources/lib/perfect-scrollbar.min.js"></script>
