...
<div class="col-sm-12 col-xs-12 ">
	...
	{/if}
	<input type="hidden" value='{Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($SEARCH_PARAMS))}' id="search_params" name="search_params">
	{if !$SEARCH_MODE_RESULTS}
		{include file="GraphFilterListViewActions.tpl"|vtemplate_path:$MODULE}
	{/if}
