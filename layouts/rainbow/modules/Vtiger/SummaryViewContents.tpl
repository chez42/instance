			...
			<tr class="summaryViewEntries">
				...
				<td class="fieldValue">
                    <div class="row">
                        ...
                        <span class="value textOverflowEllipsis" data-field-type="{$FIELD_MODEL->getFieldDataType()}" title="{strip_tags($DISPLAY_VALUE)}"  {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20' or $FIELD_MODEL->get('uitype') eq '21'}style="word-wrap: break-word;"{/if}>
                        ...
                        {if $FIELD_MODEL->isEditable() eq 'true' && $IS_AJAX_ENABLED && $FIELD_MODEL->isAjaxEditable() eq 'true' && $FIELD_MODEL->get('uitype') neq 69}
                            ...
                            <span class="action"><a href="#" onclick="return false;" class="editAction ti-pencil text-info"></a></span>
                        {/if}
                    </div>
				</td>
			</tr>
