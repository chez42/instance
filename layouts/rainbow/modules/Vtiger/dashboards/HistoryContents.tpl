				...
				{if $PROCEED}
					<div class="row entry clearfix">
						<div class='col-lg-2 col-xs-3 pull-left'>
							...
							<span>
							{*<i class="material-icons entryIcon" title={$TRANSLATED_MODULE_NAME}>{$iconsarray[{strtolower($VT_ICON)}]}</i>*}
							<i class=" entryIcon vicon-{strtolower($VT_ICON)}" title={$TRANSLATED_MODULE_NAME}></i>
							</span>&nbsp;&nbsp;
						</div>
