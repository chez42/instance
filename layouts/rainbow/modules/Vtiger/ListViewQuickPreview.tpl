...
********************************************************************************/
-->*}
<div class = "quickPreview animated fadeIn">
    ...
    <div class='quick-preview-modal modal-content'>
        <div class='modal-body'>
            ...
            <div class="quickPreviewActions clearfix">
                ...
                {if $NAVIGATION}
                    <div class="btn-group pull-right">
                        <button class="btn btn-secondary" id="quickPreviewPreviousRecordButton" data-record="{$PREVIOUS_RECORD_ID}" data-app="{$SELECTED_MENU_CATEGORY}" {if empty($PREVIOUS_RECORD_ID)} disabled="disabled" {*{else} onclick="Vtiger_List_Js.triggerPreviewForRecord({$PREVIOUS_RECORD_ID})"*}{/if} >
                            <i class="ti-angle-left"></i>
                        </button>
                        <button class="btn btn-secondary" id="quickPreviewNextRecordButton" data-record="{$NEXT_RECORD_ID}" data-app="{$SELECTED_MENU_CATEGORY}" {if empty($NEXT_RECORD_ID)} disabled="disabled" {*{else} onclick="Vtiger_List_Js.triggerPreviewForRecord({$NEXT_RECORD_ID})"*}{/if}>
            ...
            <div class = "quickPreviewSummary">
                <table class="summary-table no-border table table-striped table-hover" style="width:100%;">
                    <tbody>
