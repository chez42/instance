        ...
        <div class="modal-content">
            <form class="form-horizontal" id="massEmailForm" method="post" action="index.php" enctype="multipart/form-data" name="massEmailForm">
                            ...
                            <div class="col-lg-4 input-group" style = "display:none;">
                                ...
                                <span class="input-group-addon">
                                    <span class="selectEmail cursorPointer">
                                        <i class="ti-search" title="{vtranslate('LBL_SELECT', $MODULE)}"></i>
                                    </span>
                                </span>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 brownseInCrm">
                                        <button type="button" class="btn btn-small btn-success pull-left" id="browseCrm" data-url="{$DOCUMENTS_URL}" title="{vtranslate('LBL_BROWSE_CRM',$MODULE)}">{vtranslate('LBL_BROWSE_CRM',$MODULE)}</button>
                                    </div>
                        ...
                        <div class="col-lg-10">
                            <div class="row">
	                            <div class="item col-lg-1">
	                                <input class="pull-left" type="checkbox" name="signature" value="Yes" checked="checked" id="signature">
	                            </div>
	                          	<div class="col-lg-6 insertLink">
	                                <button type="button" class="btn btn-small btn-success pull-left" id="insertLink" data-url="module=Documents&view=InsertLinkPopup&src_module=Emails&src_field=composeEmail" title="{vtranslate('Insert Link',$MODULE)}">{vtranslate('Insert Link',$MODULE)}</button>
	                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="saveDraft" name="savedraft" class="btn btn-warning" title="{vtranslate('LBL_SAVE_AS_DRAFT',$MODULE)}" type="submit"><strong>{vtranslate('LBL_SAVE_AS_DRAFT',$MODULE)}</strong></button>&nbsp;
                </div>
            </form>
        </div>
    </div>
