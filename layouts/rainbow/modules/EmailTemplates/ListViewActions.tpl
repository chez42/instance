        ...
        <div class = "row">
            <div class="btn-toolbar col-md-3" role="group" aria-label="...">
                <div class="btn-group" role="group" aria-label="...">
                    <button type="button" class="btn btn-secondary viewType" title="{vtranslate('LBL_LIST_VIEW',$MODULE)}" data-mode="list" {if $VIEWTYPE eq 'list'} disabled="disabled" {/if}><i class="ti-view-list"></i></button>
                    <button type="button" class="btn btn-secondary viewType" title="{vtranslate('LBL_THUMBNAIL_VIEW',$MODULE)}" data-mode="grid" {if $VIEWTYPE eq 'grid'} disabled="disabled" {/if}><i class="ti-view-grid"></i></button>
                </div>
                <div class="btn-group">
                {if $editAction}
                ...
                {/if}
                {if $deleteAction}
                    <button type="button" class="btn btn-danger {if $VIEWTYPE eq 'grid'}hide{/if}" id={$MODULE}_listView_massAction_{$deleteAction->getLabel()} 
