					...
					<div class="blockData">
						<table class="table detailview-table no-border">
							<tbody>
								...
								{if $FIELD_MODEL_LIST|@end eq true and $BLOCK_LABEL_KEY eq 'LBL_CUSTOMER_PORTAL_INFORMATION'}	
									<tr>
										<td colspan="{$NUM_OF_COL*2}">
											{include file=vtemplate_path("PortalBlockInfoDetailView.tpl",$MODULE_NAME)}
						       			</td>
					       			</tr>
						        {/if}
							</tbody>
