				...
				<tbody class="overflow-y">
					...
					{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
						...
						{if $LISTVIEW_HEADER->get('name') neq 'createdtime' && $LISTVIEW_HEADER->get('name') neq 'modifiedtime'}nowrap{/if}>
							...
							{if $LISTVIEW_HEADER->isEditable() eq 'true' && $LISTVIEW_HEADER->isAjaxEditable() eq 'true' && $LISTVIEW_HEADER->getName() neq 'contact_id' || $LISTVIEW_HEADER->getName() eq 'activitytype' || $LISTVIEW_HEADER->getName() eq 'eventstatus'}
