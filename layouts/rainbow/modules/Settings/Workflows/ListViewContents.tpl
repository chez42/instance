		...
		<div class = "row">
			...
			<div class="col-md-4">
				<div class="search-link hidden-xs" style="margin-top: 0px;">
					<span aria-hidden="true" class="ti-search"></span>
		...
		<div class="list-content row">
			<div class="col-sm-12 col-xs-12 ">
				<div id="table-content" class="table-container" style="padding-top:0px !important;">
					<table id="listview-table" class="workflow-table table table-hover listview-table">
									...
									{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
										...
										{elseif $LISTVIEW_HEADERNAME eq 'module_name' && empty($SOURCE_MODULE)}
											<td class="listViewEntryValue {$WIDTHTYPE}" width="{$WIDTH}%" nowrap>
												...
												{/if}
												<i class="ti-{$MODULE_ICON_NAME}" title='{$LISTVIEW_ENTRY->get('module_name')}'>&nbsp;</i>
											</td>
										{else}
										{/if}
									{/foreach}
