							...
							<div class="pull-right">
								<div class="dropdown">
									<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
										<span class="ti-plus" title="{vtranslate('LBL_NEW_DOCUMENT', $MODULE_NAME)}"></span>&nbsp;<span class="hidden-sm hidden xs">{vtranslate('LBL_NEW_DOCUMENT', $MODULE_NAME)}</span> &nbsp; <span class="caret"></span>
									</button>
