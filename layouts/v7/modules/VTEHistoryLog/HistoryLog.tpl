...
* ****************************************************************************** */*}
{literal}
    <link type="text/css" rel="stylesheet" href="layouts/v7/modules/VTEHistoryLog/resources/VTEHistoryLog.css" media="screen">
{/literal}
{strip}

    <div class="recentActivitiesContainer vteRecentActivitiesContainer" id="updates">
                            ...
                            {if $RECENT_ACTIVITY->isCreate()}
                                <li>
                                    <time class="update_time cursorDefault">
                                        ...
                                        <small class="module-qtip" title="{$CREATED_DATE_TIME_ARR[1]} {$CREATED_DATE_TIME_ARR[2]}">
                                            {$CREATED_DATE_TIME_ARR[0]}
                                        </small>
                                    </time>
                                    <div class="update_icon bg-info bg-info-{$PARENT_MODULE_NAME_LOWER}">
                                        <i class='module-qtip update_image vicon-{$PARENT_MODULE_NAME_LOWER}' title="{vtranslate($RECENT_ACTIVITY->get('parent_modulename'), $RECENT_ACTIVITY->get('parent_modulename'))}"></i>
                                    </div>
                                    <div class="update_info">
                                        <div class="update_info_block">
                                            <div class="update_info_block_header">
                                                <i class="fa fa-caret-left" aria-hidden="true"></i>
                                                <i class="fa fa-caret-left fa-caret-left-border" aria-hidden="true"></i>
                                                <span class="update_icon bg-info vte-bg-info-small bg-info-{$MODULE_NAME_LOWER}">
                                                    <i class='module-qtip update_image vicon-{$MODULE_NAME_LOWER}' title="{vtranslate($RECENT_ACTIVITY->get('module'), $RECENT_ACTIVITY->get('module'))}"></i>
                                                </span>
                                            ...
                                            <div class="update_info_block_header">
                                                ...
                                                <span class="update_icon bg-info vte-bg-info-small bg-info-{$MODULE_NAME_LOWER}">
                                                    {if $MODULE_NAME_LOWER eq 'modcomments'}
                                                        <i class='module-qtip update_image vicon-chat' title="{vtranslate($RECENT_ACTIVITY->get('module'), $RECENT_ACTIVITY->get('module'))}"></i>
                                                    {else}
                                                        <i class='module-qtip update_image vicon-{$MODULE_NAME_LOWER}' title="{vtranslate($RECENT_ACTIVITY->get('module'), $RECENT_ACTIVITY->get('module'))}"></i>
                                                    {/if}
                                                </span>
                                                    ...
                                                    <div class='font-x-small updateInfoContainer {if $COUNT_FIELD gt $LIMIT_FIELD} hide{/if}'>
                                                        ...
                                                        <div class="update-to">
                                                            ...
                                                            {elseif $FIELDMODEL->getFieldInstance()->getFieldDataType() eq 'reference' && $FIELDMODEL->get('postvalue') neq '0' && $FIELDMODEL->get('prevalue') eq '0'}
                                                                ...
                                                                <span class="update-from">
                                                                    <em style="white-space:pre-line;">
                                                                        (<span class="from_field_value">{vtranslate('LBL_LINKED')}</span>)
                                                                    </em>
                                                                </span>
                                                            {else}
                            ...
                            {elseif ($RECENT_ACTIVITY->isRelationLink() || $RECENT_ACTIVITY->isRelationUnLink())}
                                ...
                                <li>
                                    ...
                                    <div class="update_icon bg-info bg-info-{$RELATION->getParent()->get('module')|strtolower}">
                                        <i class='module-qtip update_image vicon-{$RELATION->getParent()->get('module')|strtolower}' title="{vtranslate($RELATION->getParent()->get('module'), $RELATION->getParent()->get('module'))}"></i>
                                    </div>
                                            ...
                                            <div class="update_info_block_header">
                                                ...
                                                <span class="update_icon bg-info bg-info-{$RELATED_MODULE|strtolower} vte-bg-info-small">
                                                    {if $RELATED_MODULE eq 'ModComments'}
                                                        <i class='module-qtip update_image vicon-chat' title="{vtranslate($RELATED_MODULE, $RELATED_MODULE)}"></i>
                                                    {else}
                                                        <i class='module-qtip update_image vicon-{$RELATED_MODULE|strtolower}' title="{vtranslate($RELATED_MODULE, $RELATED_MODULE)}"></i>
                                                    {/if}
                                                </span>
                                                {if $RELATED_MODULE eq 'ModComments'}
