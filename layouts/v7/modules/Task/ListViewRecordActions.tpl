...
<style>
	.listview-table .task-table-actions {
	    width: 135px ! important;
	}
</style>
<div class="table-actions task-table-actions">
	...
	{if $IS_MODULE_EDITABLE && $EDIT_VIEW_URL && $LISTVIEW_ENTRY->get('task_status') neq vtranslate('Completed', $MODULE)}
		<span>
			<a class="fa fa-check icon action markAsHeld" title="{vtranslate('LBL_MARK_AS_HELD', $MODULE)}" ></a> 
		</span>
	{/if}
