...
jQuery.Class("Settings_OwnCloud_Js",{},{
		...
		app.request.post({'data' : params}).then(
			function(err, data) {
                ...
                if(data.success == true){
                    ...
                    var OwnCloudDetailUrl = form.data('url');
                	thisInstance.loadContents(OwnCloudDetailUrl).then(function(data) {
	...
	registerEditViewEvents : function(e) {
		...
		cancelLink.click(function(e) {
			...
			thisInstance.loadContents(OwnCloudDetailUrl).then(
				function(data) {
...
jQuery(document).ready(function(){
	var instance = new Settings_OwnCloud_Js();
