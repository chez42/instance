...
<div class="reportContents">
    <form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
        ...
        <div style="border:1px solid #ccc;padding:4%;">
            ...
            {* 02 Aug 2018 change for assigned userid *}
            
           {* <div class="row">
                <div class="form-group">
                    <label class="col-lg-3 control-label textAlignLeft">{vtranslate('Assigned To',$MODULE)}<span class="redColor">*</span></label>
                    <div class="col-lg-4">
                    	{assign var=ALL_ACTIVEUSER_LIST value=$USER_MODEL->getAccessibleUsers()}
						{assign var=ALL_ACTIVEGROUP_LIST value=$USER_MODEL->getAccessibleGroups()}
						{assign var=ASSIGNED_USER_ID value="report_assigned_user_id"}
					    {assign var=CURRENT_USER_ID value=$USER_MODEL->get('id')}
						{assign var=FIELD_VALUE value=$REPORT_MODEL->get('assigned_user_id')}
            ...
            {* 02 Aug 2018 change for assigned userid END *}
