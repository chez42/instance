...
{strip}
    <form class="form-horizontal recordEditView padding1per" id="chart_report_step3" method="post" action="index.php">
		...
		{*<input type="hidden" name="report_assigned_user_id" value="{$REPORT_MODEL->get('report_assigned_user_id')}" />*}
                            ...
                            <div class="row tab-pane active">
                                <div>
                                    ...
                                    <span class="col-lg-3">
                                        ...
                                        <div class="row">
                                            <select id='orderby' name='orderby' class="select2" style='min-width:300px;'>
