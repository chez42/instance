...
{* ADVANCE FILTER END *}
                <div class="row-fluid">
                    <div class="textAlignCenter">
                        <button type="button" class="btn generateReport" id="generateReportNow" data-mode="generate" value="{vtranslate('LBL_GENERATE_NOW',$MODULE)}"/>
                        ...
                        {if $checkDashboardWidget != "" && $checkDashboardWidget != "Exist"}
                            &nbsp;&nbsp;<button type="button" class="btn addWidget" data-mode="addwidget" data-type = "false" value="{vtranslate('LBL_ADD_WIDGET',$MODULE)}"/>
                                <strong>{vtranslate('LBL_ADD_WIDGET',$MODULE)}</strong>
                            </button>
                        {/if}
                        {if  $checkDashboardListWidget != ""  && $checkDashboardListWidget != "Exist"}
                            &nbsp;&nbsp;<button type="button" class="btn addWidget" data-mode="addwidget" data-type = "true" value="{vtranslate('Add Detail to dashboard home page',$MODULE)}"/>
...
<script>
    jQuery(document).ready(function () {
        jQuery('#XLSExport,#CSVExport').click(function(e){
            ...
            var newForm = jQuery('<form>', {
                ...
                type: 'hidden',
                name: 'hd_html_content',
                value: jQuery('#vteTable').html()
            })).append(jQuery('<input>').attr({
                type: 'hidden',
                name: '__vtrftk',
                value: jQuery('input[name="__vtrftk"]').val()
            }));
