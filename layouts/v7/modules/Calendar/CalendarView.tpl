...
{strip}
<link type="text/css" rel="stylesheet" href="layouts/v7/skins/marketing/style.css" media="print" />
<link type="text/css" rel="stylesheet" href="layouts/v7/lib/jquery/fullcalendar/print2.css" media="print" />
...
<style media="print">
	...
	.vicon-meeting{ display : none; }
	
</style>
<div id="mycalendar" class="calendarview col-lg-12">
	{assign var=LEFTPANELHIDE value=$CURRENT_USER_MODEL->get('leftpanelhide')}
	<div class="essentials-toggle noprint" title="{vtranslate('LBL_LEFT_PANEL_SHOW_HIDE', 'Vtiger')}">
