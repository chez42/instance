                                                                                    ...
                                                                                    {foreach item=DOCUMENT from=$ITEM.documents}
                                                                                        <li class="">
                                                                                            <a href="index.php?module=Documents&action=DownloadFile&record={$DOCUMENT.crmid}&fileid={$DOCUMENT.attachmentsid}">{$DOCUMENT.title}
                                                                                                <span class="relationDelete pull-right" data-record="{$ITEM.checklistitemsid}" data-related-record="{$DOCUMENT.crmid}"><i title="Delete" class="fa fa-trash alignMiddle"></i></span>
                                                                                            </a>
                                                                                        </li>
                                                                                    {/foreach}
                                                                                {/if}
