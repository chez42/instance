    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4>{vtranslate('VTE Quick Edit')} {vtranslate($SINGLE_MODULE, $MODULE)}</h4>
            </div>
            <form class="form-horizontal recordEditView" name="VTEQuickEdit" method="post" action="index.php">
                <div class="modal-body">
                        {if !empty($PICKIST_DEPENDENCY_DATASOURCE)}
                            <input type="hidden" name="picklistDependency" value='{Vtiger_Util_Helper::toSafeHTML($PICKIST_DEPENDENCY_DATASOURCE)}' />
                        {/if}
                        <input type="hidden" name="module" value="VTEQuickEdit">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success" name="vteQuickEditSaveButton" type="button"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
