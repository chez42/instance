            ...
            <div class="tab-content layoutContent padding20 themeTableColor overflowVisible">
                ...
                <div class="tab-pane col-sm-12 col-xs-12" id="relatedTabContent">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-4 col-xs-4">
                            <div class="row">
                                <div style="margin-top: 7px" class="col-sm-3 col-xs-3">{vtranslate('LBL_ADD_TEMPLATE',$QUALIFIED_MODULE)}</div>&nbsp;&nbsp;
                                <div class="col-sm-8 col-xs-8">
                                    <select style="width: 205px" id="insert_template" name="insert_template" class="select2"
                                            data-placeholder={vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)} >
                                        <option></option>
