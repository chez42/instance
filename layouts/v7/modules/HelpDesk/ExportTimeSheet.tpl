...
{strip}
	<div class="fc-overlay-modal modal-content">
		<form id="exportForm" class="form-horizontal" method="post" action="index.php">
			...
			<input type="hidden" name="action" value="ExportTimeSheet" />
					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
								<div>
									<input type="radio" name="mode" value="ExportSelectedRecords" id="group1" checked="checked"  style="margin:2px 0 -4px" />
									<label style="font-weight:normal" for="group1">&nbsp;&nbsp;{vtranslate('Export Timecontrol Data',$MODULE)}</label>
								</div>
