...
<div class="table-actions">
    ...
    {assign var=RECORDMODEL value=Vtiger_Record_Model::getInstanceById($LISTVIEW_ENTRY->getId())}
   	{assign var=isTicket value=$RECORDMODEL->getRelationModule()}
   	
   	{if $isTicket}
    	<span class="ticketView vicon-helpdesk icon action" style="font-size:1em;" onclick="Timecontrol_List_Js.TicketPreview({$isTicket})" data-app="{$SELECTED_MENU_CATEGORY}" title="{vtranslate('Ticket Quick View', $MODULE)}" style=""></span>
	{/if}
