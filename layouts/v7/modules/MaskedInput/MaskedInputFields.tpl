                    ...
                    <td nowrap class="{$WIDTHTYPE}">
                        <div class="actions pull-right">
                            <span class="actionImages">
                                    <a href='javascript: void(0);' class="editRecordButton" data-url="index.php?module=MaskedInput&view=EditAjax&mode=getConfiguredFieldForm&record={$ID}"><i title="{vtranslate('LBL_EDIT')}" class="glyphicon glyphicon-pencil alignMiddle"></i></a>&nbsp;
