...
{literal}
    <style>
        .lnk-popover{
            ...
            margin-top: 2px;
            background-image: url("layouts/v7/modules/VTEPayments/resources/img/cal.png");
    ...
    <script src="layouts/v7/modules/VTEPayments/resources/bootstrap.min.js"></script>
{/literal}
{strip}
    <div class='container-fluid editViewContainer' style="padding: 0px 20px; margin: 0 auto;">
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
            ...
            <table class="table table-bordered blockContainer showInlineTable equalSplit">
                <thead>
                    <tr>
                        <th class="myBlockHeader blockHeader" colspan="4">
                ...
                <td class="fieldValue {$WIDTHTYPE}" {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
                    <div class="row">
                        ...
                        {if $FIELD_MODEL->getName() == 'amount_paid' }
                            <div class="col-lg-2 t-container">
...
{/foreach}
{/strip}
{if $VIEWNAME=='ManagePayments'}<div style="text-align: center"><button class="btn-success" name="btnRecordPayment" id="btnRecordPayment" type="submit"><strong>{vtranslate('Record Payment', 'VTEPayments')}</strong></button><br><br></div>{/if}
