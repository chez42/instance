...
<div class="input-group">
	...
	<input id="{$MODULE}_editView_fieldName_{$FIELD_NAME}" type="text" class="inputElement currencyField"
        data-validation-engine="validate[
            {if $FIELD_MODEL->isMandatory() eq true} required,{/if}
            {if $FIELD_MODEL->getFieldName()!='amount_paid'}funcCall[Vtiger_Base_Validator_Js.invokeValidation]{/if}
        ]"
