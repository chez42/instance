...
Vtiger.Class("VTE_Conditional_Alerts_Js",{
    ...
    checkConditionToForm:function(all_condition,any_condition,field_name_changed,record_info){
        var thisInstance = this;
        var is_all = true;
        var is_any = false;
        ...
        jQuery.each(all_condition,function(key,value){
            ...
            var main_form = jQuery('#EditView,#detailView,#QuickCreate');
    ...
    registerPostReferenceEvent : function(container) {
        ...
        container.find('.sourceField').on(Vtiger_Edit_Js.popupSelectionEvent,function(e,data){
