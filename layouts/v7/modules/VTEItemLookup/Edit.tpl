...
<div class="container-fluid WidgetsManage">
    <div class="widget_header row">
        <div class="col-sm-6"><h4><label>{vtranslate('VTEItemLookup', 'VTEItemLookup')}</label>
        </div>
    </div>
    <hr>
    <div class="clearfix"></div>
    <div class="editViewPageDiv">
        <form id="EditView" action="index.php" method="post" name="EditVTEItemLookup">
            <input type="hidden" name="module" id="module" value="{$MODULE}">
            <input type="hidden" name="action" value="SaveVTEItemLookup" />
            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="col-sm-6 col-xs-6 custom-expenses-info">
                    ...
                    <span>
                        ...
                        <b>Name:</b> Name displayed in "+ Add Custom Expense" selection.<br>
                        <b>Quantity:</b> Map item quantity field from selected module. (if left blank, the quantity will default to 1).<br>
                        <b>Price: </b>Map item price field from selected module. (if left blank, the quantity will default to 0).<br>
                        <b>Description:</b> Map item description from selected module.<br>
                        <b>Default Item:</b> Can be a Product or a Service. This field is required.<br>
