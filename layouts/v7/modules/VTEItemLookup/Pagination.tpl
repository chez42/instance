...
<div class = "{$CLASS_VIEW_ACTION}">
    ...
    {include file="Anphabet.tpl"|vtemplate_path:$VTE_MODULE}
    <button style="margin-left: 20px;color: darkred;" data-dismiss="modal" aria-label="Close" class="btn btn-default"><strong>Close</strong></button>
</div>