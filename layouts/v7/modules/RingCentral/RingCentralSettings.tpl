...
{strip}
	...
	<div class="editViewPageDiv editViewContainer" id="ringcentral" style="padding-top:0px;">
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="clearfix">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<h3 style="margin-top: 0px;">{vtranslate('Ringcentral Auth Settings', $QUALIFIED_MODULE)}</h3>
				</div>
				{if $mode neq 'edit'}
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			...
			<form id="updatedetails" data-url="{$URL}&mode=detail" method="POST">
				...
				<div class="blockData">
					...
					<div class="block">
						<div>
							<h4>{vtranslate('RingCentral Details', $QUALIFIED_MODULE)}</h4>
						</div>
						<hr>
						{if $mode eq 'edit'}
