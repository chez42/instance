...
jQuery.Class("Settings_RingCentral_Js",{},{
	
	/*
	 * function to Save the Outgoing Server Details
	 */
	saveRingCentralDetails : function(form) {
		...
		app.request.post({'data' : params}).then(
			function(err, data) {
                ...
                if(data.success == true){
                    ...
                    var ringcentralDetailUrl = form.data('url');
                	thisInstance.loadContents(ringcentralDetailUrl).then(function(data) {
	...
	registerEditViewEvents : function(e) {
		...
		var params = {
            submitHandler : function(form) {
				...
				thisInstance.saveRingCentralDetails(form);
            }
		};
		if (form.length) {
		...
		cancelLink.click(function(e) {
			var ringcentralDetailUrl = form.data('url');
			console.log(ringcentralDetailUrl);
			thisInstance.loadContents(ringcentralDetailUrl).then(
				function(data) {
	...
	registerDetailViewEvents : function() {
		...
		var container = jQuery('#ringcentral');
...
jQuery(document).ready(function(){
	var instance = new Settings_RingCentral_Js();
