    ...
    <div class="editViewContents">
        <div name='editContent'>
            <div class="tab-content">
                ...
                <input type="hidden" name="relationIdPotentials" value="{$RELATION_ID['relationIdPotentials']}">
                ...
                <div class="row toolbar">
                    <div class="col-lg-12 marketinglist-toolbar"
                         style="height: 200px; padding-top: 25px; padding-bottom: 20px">
                        <div class="col-lg-1 border">
                            <div class="content-column">
                                ...
                                <h5> Show {vtranslate('Potentials','Potentials')} Lists
                                    <button type="button" id="show-potentials-list" module="Potentials"
                                            class="btn btn-sm btn-toggle pull-right btn-on-off-filter"
                                            data-toggle="button" aria-pressed="true" autocomplete="off">
                                        <div class="handle"></div>
                                    </button>
                        ...
                        <div class="col-lg-2 border">
                            <div class="content-column">
                                ...
                                <div class="btn-group">
                                 ...
                                 <div class="btn-group">
                                    <button data-url="{CustomView_Record_Model::getCreateViewUrl('Potentials')}"
                                            class="btn addButton btn-default createFilter"
                                            title="{vtranslate('LBL_CREATE_LIST',$MODULE)}">
                                        <i class="fa fa-plus"></i>&nbsp;{vtranslate('CREATE_POTENTIALS_LIST',$MODULE)}
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 border">
                            <div class="content-column">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn addButton btn-default selectRelation"
                                            module="VTEEmailMarketing" moduleRel="Potentials">
                                        {vtranslate('SELECT_POTENTIALS',$MODULE)}
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        {*foreach item=value key=key from=$FILTER}
                            <tr module="{$value['module']}" class="hide">
                                <td>
                                    ...
                                    {elseif $value['module'] eq 'Potentials'}
                                    	 <h5> <i class="vicon-potentials module-icon"></i>{vtranslate($value['module'],$value['module'])}</h5>
                                    {else}
