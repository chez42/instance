...
-->*}
{strip}
	<div class="listViewPageDiv">dddddddddddddddd
		<div class="listViewTopMenuDiv noprint">
			<div class="listViewActionsDiv row-fluid">
				<span class="btn-toolbar span6">
						...
						<span class="btn-group">
							{if $LISTVIEW_BASICACTION->getLabel() eq 'LBL_CONFIGURE_ACTIONS'}
								<button id="{$MODULE}_listView_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores($LISTVIEW_BASICACTION->getLabel())}" class="btn btn-info"
									...
									<i class="icon-cog"></i>&nbsp;<strong>{vtranslate($LISTVIEW_BASICACTION->getLabel(), $MODULE)}</strong>
								</button>
							{elseif $LISTVIEW_BASICACTION->getLabel() eq 'LBL_CREATE_ACTION'}
								<button id="{$MODULE}_listView_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores($LISTVIEW_BASICACTION->getLabel())}"
										...
										onclick="javascript:VTEMailConverter_List_Js.createAction();">
							...
							{elseif $LISTVIEW_BASICACTION->getLabel() eq 'LBL_CRON_EXECUTE'}
								<button id="{$MODULE}_listView_basicAction_{Vtiger_Util_Helper::replaceSpaceWithUnderScores($LISTVIEW_BASICACTION->getLabel())}"
									...
									<i class="icon-refresh"></i>&nbsp;<strong>{vtranslate($LISTVIEW_BASICACTION->getLabel(), $MODULE)}</strong>
								</button>
							{else}
