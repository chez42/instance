...
{strip}
    <div class="installationContents" style="padding-left: 3%;padding-right: 3%">
        <form name="EditWorkflow" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="padding1per" style="border:1px solid #ccc; padding: 10px;">
                <label>
                ...
                <div class="control-group" style="margin-bottom:10px; text-align: left;">
                    <div class="control-label" style="text-align: left;"><strong>{vtranslate('LBL_VTIGER_URL',$QUALIFIED_MODULE)}</strong></div>
                ...
                <div class="control-group" style="margin-bottom:10px; text-align: left;">
                    <div class="control-label" style="text-align: left;"><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></div>
                    <div class="controls">
                        <input type="text" id="license_key" name="license_key" value="" data-validation-engine="validate[required]" class="inputElement" style="width: 450px;">
                    </div>
                </div>
