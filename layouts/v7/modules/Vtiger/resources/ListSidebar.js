...
Vtiger.Class('Vtiger_ListSidebar_Js',{},{
	...
	registerFilters: function() {
        ...
        jQuery.each(scrollContainers,function(key,scroll){
			...
			if(scroll.find(".list-menu-content").height() > 150){
        ...
        /*if(filters.find(".scrollContainer.tags").length > 0){
        	
        	var scrollContainers = filters.find(".scrollContainer.tags");
        	jQuery.each(scrollContainers,function(key,scroll){
                 var scroll = jQuery(scroll);
                 
				 if(scroll.find(".list-menu-content").height() > 100){
    ...
    registerTagClick : function() {
        ...
        jQuery('#listViewTagContainerMore').on('click', '.moreTags', function(e){
