        ...
        <div class="col-sm-9 col-xs-9">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-5 col-xs-5">
                    {assign var=STATUS_PICKLIST_VALUES value=$TASK_TYPE_MODEL->getTaskBaseModule()->getField('task_status')->getPickListValues()}
                ...
                {$SHOWN_FIELDS_LIST['task_status'] = 'task_status'}
            </div>
            <div class="row form-group">
                <div class="col-sm-2 col-xs-2">{vtranslate('LBL_PRIORITY',$QUALIFIED_MODULE)}</div>
                <div class="col-sm-5 col-xs-5">
                    {assign var=PRIORITY_PICKLIST_VALUES value=$TASK_TYPE_MODEL->getTaskBaseModule()->getField('task_priority')->getPickListValues()}
                ...
                {$SHOWN_FIELDS_LIST['task_priority'] = 'task_priority'}
            </div>
            <div class="row form-group">
           ...
           {* <div class="row form-group">
            ...
            {assign var=QUALIFIED_MODULE value='Task'}
