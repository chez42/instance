...
{strip}
	<div class="row" style="width:540px;">
		<div style="margin-top: 7px; padding-left:15px;">
		...
		<div class="" id="repeatUI" style="display: {if $RECURRING_INFORMATION['recurringcheck'] eq 'Yes'}block{else}none{/if};">
			<div class="row">
				<div class="col-md-3">
			...
			<div class="row" style="margin-top:10px;">
				...
				<div class="col-md-9">
					<span class="input-group date  inputElement recurring_date">
