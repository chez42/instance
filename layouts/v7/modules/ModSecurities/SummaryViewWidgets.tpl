...
{strip}
	{foreach item=DETAIL_VIEW_WIDGET from=$DETAILVIEW_LINKS['DETAILVIEWWIDGET']}
		...
		{elseif ($DETAIL_VIEW_WIDGET->getLabel() eq 'Historical Data')}
			{assign var=HISTORICAL_WIDGET_MODEL value=$DETAIL_VIEW_WIDGET}
	...
	<div class="left-block col-lg-4">
		...
		{if $REPORTING_REVENUE_WIDGET_MODEL}
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_risk_assessment" data-url="{$REPORTING_REVENUE_WIDGET_MODEL->getUrl()}" data-name="{$COMMENTS_WIDGET_MODEL->getLabel()}">
					<div class="widget_header">
	...
	<div class="middle-block col-lg-8">
		...
		{* Historical Widget Model Start*}
		{if $HISTORICAL_WIDGET_MODEL}
			<div class="row-fluid">
				<div class="span12">
					<div class="summaryWidgetContainer">
						<div class="widgetContainer_" data-url="{$HISTORICAL_WIDGET_MODEL->getUrl()}" data-name="{$HISTORICAL_WIDGET_MODEL->getLabel()}">
							<div class="widget_header row-fluid">
								<span class="span8 margin0px"><h4>{vtranslate($HISTORICAL_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
							</div>
							<div class="widget_contents">
							</div>
						</div>
