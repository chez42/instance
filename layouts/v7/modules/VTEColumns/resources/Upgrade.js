 ...
 * All Rights Reserved.
 * ****************************************************************************** */
Vtiger.Class("VTEColumns_Upgrade_Js",{
            ...
            app.request.post({'data':params}).then(
                function(err,data){
                    ...
                    if(err === null) {
                        ...
                        app.helper.showSuccessNotification(params);
                        document.location.href="index.php?module=VTEColumns&parent=Settings&view=Settings&mode=step2";
                    }
                }
            ); 
        });
...
jQuery(document).ready(function(){
    var instance = new VTEColumns_Upgrade_Js();
