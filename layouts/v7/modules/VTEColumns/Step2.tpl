...
{strip}
    <div class="installationContents" style="padding-left: 3%;padding-right: 3%">
        <form name="EditWorkflow" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="padding1per" style="border:1px solid #ccc;padding: 10px 5px;">
                <label>
                ...
                <div class="control-group" style="margin-bottom:10px;">
                    <div class=""><strong>{vtranslate('LBL_VTIGER_URL',$QUALIFIED_MODULE)}</strong></div>
                ...
                <div class="control-group" style="margin-bottom:10px;">
                    <div class=""><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></div>
                    <div class="controls"><input type="text" id="license_key" name="license_key" value="" data-validation-engine="validate[required]" class="inputElement" name="summary"></div>
                </div>
                {if $VTELICENSE->result eq 'bad' || $VTELICENSE->result eq 'invalid'}
                    <div class="alert alert-danger" id="error_message">{$VTELICENSE->message}</div>
                {/if}
                ...
                <div class="control-group" style="text-align: center;">
                    ...
                    <button class="btn btn-info" name="btnOrder" type="button" onclick="window.open('http://www.vtexperts.com/extension/vtiger-advanced-custom-fields-html-description-assigned-to/')"><strong>{vtranslate('LBL_ORDER_NOW', $QUALIFIED_MODULE)}</strong></button>
                </div>
            </div>
        </div>
