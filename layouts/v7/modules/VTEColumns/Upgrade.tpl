    ...
    <div class="installationContents" style="padding-left: 3%;padding-right: 3%">
        <div class="padding1per" style="border:1px solid #ccc;">
            <div class="row" style="margin-bottom:10px;">
                <span class="col-md-2" style="text-align: right"><strong>{vtranslate('LBL_VTIGER_URL',$QUALIFIED_MODULE)}</strong></span>
                <span class="col-md-10">{$LICENSE_INFO['site_url']}</span>
            </div>
            <div class="row" style="margin-bottom:10px;">
                <span class="col-md-2" style="text-align: right"><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></span>
                <span class="col-md-10">{$LICENSE_INFO['license']}</span>
            </div>
            <div class="row" style="margin-bottom:10px;">
                <span class="col-md-2" style="text-align: right"><strong>{vtranslate('LBL_LICENSE_EXPIRES',$QUALIFIED_MODULE)}</strong></span>
                <span class="col-md-10">{$LICENSE_EXPIRES}</span>
            </div>
            <div class="row" style="margin-bottom:10px;">
                <span class="col-md-2" style="text-align: right"><strong>{vtranslate('LBL_SUPPORT_EXPIRES',$QUALIFIED_MODULE)}</strong></span>
                <span class="col-md-10">{$SUPPORT_EXPIRES}</span>
            </div>
