			...
			function(data) {
				...
				if(data.result) {
                    ...
                    AppConnector.request(params).then(function(data) {
                        console.log(data.result.execcond);
                        if(data.result.execcond!=7) {
                            Settings_Vtiger_Index_Js.showMessage({text : app.vtranslate('JS_WORKFLOW_SAVED_SUCCESSFULLY')}); // remove notify message for macros
                        }
                    });
