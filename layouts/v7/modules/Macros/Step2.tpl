{*/* * *******************************************************************************
* The content of this file is subject to the Individual Outgoing Email Server ("License");
...
{strip}
    <div class="installationContents" style="padding-left: 3%;padding-right: 3%">
        <form name="EditWorkflow" action="index.php" method="post" id="installation_step2" class="form-horizontal createCustomFieldForm">
            ...
            <div class="summaryWidgetContainer" style="border:1px solid #ccc;">
                ...
                <div class="control-group" style="margin-bottom:10px;">
                    <div><strong>{vtranslate('LBL_VTIGER_URL',$QUALIFIED_MODULE)}</strong></div>
                ...
                <div class="form-group" style="margin:0px;">
                    <div ><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></div>
                    <div class="controls">
                        <input type="text" id="license_key" name="license_key" value="" data-validation-engine="validate[required]" class="inputElement col-sm-9" style="width: 50%" name="summary">
                    </div>
                </div>
                ...
                <div class="control-group" style="text-align: center;">
                    ...
                    <button class="btn btn-info" name="btnOrder" type="button" onclick="window.open('http://www.vtexperts.com/extension/vtiger-outgoing-email-server/')"><strong>{vtranslate('LBL_ORDER_NOW', $QUALIFIED_MODULE)}</strong></button>
                </div>
            </div>
    </div>
