...
Vtiger.Class("Google_Map_Js", {}, {
	...
	loadMapScript : function() {
			jQuery.getScript("https://maps.google.com/maps/api/js?key=AIzaSyAw61qMIgYrkTmDgwQiSB3PpwyUrSi2DSU&sensor=true&async=2&callback=initialize", function () {});
	},

	getQueryString : function (address) {
		address = address.replace(/,/g,' ');
		address = address.replace(/ /g,'+');
		return "https://maps.google.com/maps?key=AIzaSyAw61qMIgYrkTmDgwQiSB3PpwyUrSi2DSU&q=" + address + "&zoom=14&size=512x512&maptype=roadmap&sensor=false";
	}
});
