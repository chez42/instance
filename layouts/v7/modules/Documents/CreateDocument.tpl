				...
				<form class="form-horizontal recordEditView" name="upload" method="post" action="index.php">
					...
					<table class="massEditTable table no-border">
						...
						<tr>
							...
							{assign var="FIELD_MODEL" value=$FIELD_MODELS['doc_folder_id']}
							{if $FIELD_MODELS['doc_folder_id']}
								<td class="fieldLabel col-lg-2">
									<label class="muted pull-right">
										{vtranslate($FIELD_MODEL->get('label'), $MODULE)}&nbsp;
										{if $FIELD_MODEL->isMandatory() eq true}
						...
						<tr>
							{assign var=HARDCODED_FIELDS value=','|explode:"filename,assigned_user_id,doc_folder_id,folderid,notecontent,notes_title"}
