...
//    },
	...
	getListSelectAllParams: function (jsonDecode) {
		...
		if(app.getModuleName() == 'Documents' && app.getViewName() == 'List'){
			var docSearchParams = new Array();
			var folderValue = $('[name="folder_value"]').val();
			var fieldName = $('[name="folder_id"]').val();
			if(folderValue != ''){
				params.folder_id = fieldName;
