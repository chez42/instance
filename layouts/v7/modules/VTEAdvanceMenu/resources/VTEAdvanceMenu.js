		...
		if(container.find('.vte-advance-menu-nav').length==0){
            ...
            app.request.post({data: params}).then(function(err, data) {
                ...
                if(menuElement.hasClass('vte-advance-menu-nav')) {
					container.find('#appnavigator').hide();
                    //container.find('.logo-container').removeClass('col-lg-9 col-md-9 col-sm-9 col-xs-9');
                    container.append(data);
					//container.find('.vte-advance-menu-nav').removeClass('col-lg-3 col-md-2 col-sm-2 col-xs-2').addClass('col-sm-2 col-xs-2 cursorPointer app-switcher-container');
                    ...
                    //container.find('.vte-advance-menu-nav').removeClass('pull-right').addClass('pull-left').removeAttr("style");
					//container.find('.vte-advance-menu-nav').css("margin-left", "25px"); 
