...
{strip}
	{assign var=view_permission value=$RECORD->getTemplateViewPermissionRecordNameList()}
			...
			<div class="block">
				...
				<table class="table detailview-table no-border">
					<tbody> 
						...
						<tr>
							<td class="fieldLabel {$WIDTHTYPE}"><label class="muted marginRight10px">{vtranslate('View Permission', $MODULE_NAME)}</label></td>
							<td class="fieldValue {$WIDTHTYPE}">{$view_permission}</td>
						</tr>
						<tr>
