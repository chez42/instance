        ...
        <form class="form-horizontal" id="massSaveSendEnvelope" method="post" action="index.php">
            ...
            <div class="modal-body">
            	<div class="col-md-4">
	                ...
	                <hr>
	                <div>
	                	<span><strong>{vtranslate('Select Mode',$MODULE)}</strong></span>
	                </div>
	                <br>
	                <div>
	                	<input type="radio" name="receiver_mode" checked value="single">&nbsp;Single User 
	                	
	                	&nbsp;&nbsp;&nbsp;&nbsp;
	                	
	                	<input type="radio" name="receiver_mode" value="multiple">&nbsp;Multiple Users
	                </div>
					<hr>
					<div>
					...
					<br>
					<div>
						<select name="selected_contacts" id="selected_contacts" data-rule-required="true" data-placeholder="{vtranslate('Select Contact For Sign',$MODULE)}" class = "select2 form-control multiple_con" style="display:none;">
							<option value=""></option>
						...
						<select name="selected_contacts" id="selected_contacts" data-rule-required="true" data-placeholder="{vtranslate('Select Contact For Sign',$MODULE)}" class = "select2 form-control single_con">
							<option value=""></option>
							<option value="single_signature">Signature</option>
						</select>
					</div>
					<br>
                </div>
