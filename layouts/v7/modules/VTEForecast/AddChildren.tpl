			...
			<table class="table  table-bordered table-condensed ">
				...
				<tr>
					...
					{if ($RECORD.isChecked||$RECORD.isDisabled)}							
						&nbsp;<a href="{$RECORD.objRecord->getCreateChildUrl()}" data-url="{$RECORD.objRecord->getCreateChildUrl()}" title="{vtranslate('LBL_ADD_RECORD', 'VTEForecast')}"><span class="glyphicon glyphicon-plus"></span></a>		
					{/if}
					</td>
					<td>
						{$RECORD.title}
