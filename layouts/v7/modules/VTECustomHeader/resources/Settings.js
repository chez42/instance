 ...
 * All Rights Reserved.
 * ****************************************************************************** */
Vtiger.Class("VTECustomHeader_Settings_Js",{
    instance:false,
    getInstance: function(){
        if(VTECustomHeader_Settings_Js.instance == false){
            var instance = new VTECustomHeader_Settings_Js();
            VTECustomHeader_Settings_Js.instance = instance;
            return instance;
        }
        return VTECustomHeader_Settings_Js.instance;
    }
},{
                    ...
                    function(err,data) {
                        ...
                        if(err == null){
                            ...
                            if(message !='Valid License') {
                                ...
                                document.location.href="index.php?module=VTECustomHeader&parent=Settings&view=Settings&mode=step3";
                            }
                        }
                    },
                    function(error) {
            ...
            app.request.post({data:data}).then(
                function (err,data) {
                    if(err == null){
                        app.helper.hideProgress();
                        if (data) {
                            document.location.href = "index.php?module=VTECustomHeader&parent=Settings&view=Settings";
                        }
                    }
                }
            );
    ...
    registerEnableModuleEvent:function() {
        jQuery('.summaryWidgetContainer').find('#enable_module').change(function(e) {
            ...
            var value=0;
            var text="Custom Header/Bills Disabled";
            if(element.checked) {
                value=1;
                text = "Custom Header/Bills Enabled";
            }
            var params = {};
