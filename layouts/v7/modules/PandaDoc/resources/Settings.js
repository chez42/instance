...
jQuery.Class("Settings_PandaDoc_Js",{},{
	
	/*
	 * function to Save the Outgoing Server Details
	 */
	savePandaDocDetails : function(form) {
		...
		app.request.post({'data' : params}).then(
			function(err, data) {
                ...
                if(data.success == true){
                    ...
                    var PandaDocDetailUrl = form.data('url');
                	thisInstance.loadContents(PandaDocDetailUrl).then(function(data) {
	...
	registerEditViewEvents : function(e) {
		...
		var params = {
            submitHandler : function(form) {
				...
				thisInstance.savePandaDocDetails(form);
            }
		};
		if (form.length) {
		...
		cancelLink.click(function(e) {
			...
			thisInstance.loadContents(PandaDocDetailUrl).then(
				function(data) {
...
jQuery(document).ready(function(){
	var instance = new Settings_PandaDoc_Js();
