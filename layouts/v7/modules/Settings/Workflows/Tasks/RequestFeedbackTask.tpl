...
{strip}
    <script type="text/javascript" src="layouts/v7/modules/VTEFeedback/resources/RequestFeedback.js"></script>
    <div id="VtEmailTaskContainer">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="row form-group">
                    <div class="col-sm-12 col-xs-12">
                        <textarea contenteditable="true" id="content" name="content">{$TASK_OBJECT->content}</textarea>
                    </div>
                </div>
            </div>
        </div>
