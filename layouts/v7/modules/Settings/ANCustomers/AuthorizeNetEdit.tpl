...
<style type="text/css">
    .authnet-status-active{
        background-color: #008000;
        color: #ffffff;
    }
    .authnet-status-inactive{
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="medium" style="border-left: none;">
                                        <select class="select2 inputElement" name="setting[integrate_authorize_net][active]">
                                            <option value="1" {if $INTEGRATE_AUTHORIZE_NET.active eq 1}selected="" {/if} class="authnet-status-active">{vtranslate('LBL_ACTIVE',$QUALIFIED_MODULE)}</option>
                                            <option value="0" {if $INTEGRATE_AUTHORIZE_NET.active eq 0}selected="" {/if} class="authnet-status-inactive">{vtranslate('LBL_INACTIVE',$QUALIFIED_MODULE)}</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="medium" style="border-left: none;">
                                        <select id="integrate_authorize_net_mode" class="select2 inputElement integrate_authorize_net_mode" name="setting[integrate_authorize_net][mode]" data-rule-required="true">
                                ...
                                <tr>
                                    ...
                                    <td class="medium" style="border-left: none;">
                                        <select id="integrate_authorize_net_validation_mode" class="select2 inputElement integrate_authorize_net_validation_mode" name="setting[integrate_authorize_net][validation_mode]">
                                            <option value="">{vtranslate('LBL_SELECT_AN_OPTION',$QUALIFIED_MODULE)}</option>
                                ...
                                <tr>
                                    ...
                                    <td class="medium" style="border-left: none;">
                                        <input type="text" id="integrate_authorize_net_merchant_login_id" class="inputElement integrate_authorize_net_merchant_login_id" value="{$INTEGRATE_AUTHORIZE_NET.merchant_login_id}" name="setting[integrate_authorize_net][merchant_login_id]"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="medium">
                                    ...
                                    <td class="medium" style="border-left: none;">
                                        <input type="text" id="integrate_authorize_net_merchant_transaction_key" class="inputElement integrate_authorize_net_merchant_transaction_key" value="{$INTEGRATE_AUTHORIZE_NET.merchant_transaction_key}" name="setting[integrate_authorize_net][merchant_transaction_key]"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
