...
<div class="modal-dialog modelContainer modal-lg">
	...
	{assign var=HEADER_TITLE value={vtranslate('Default Portal Permission', $MODULE)}}
	
	{include file="ModalHeader.tpl"|vtemplate_path:$MODULE TITLE=$HEADER_TITLE}
	<form class="form-horizontal" id="defaultPortalPermission" method="post" action="index.php">
