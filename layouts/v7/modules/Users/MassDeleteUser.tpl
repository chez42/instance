...
{strip}
    <div class="modal-dialog modelContainer">
        ...
        <form class="form-horizontal" id="massDeleteUser" name="massDeleteUser" method="post" action="index.php">
            <input type="hidden" name="module" value="{$MODULE}" />
            <input type="hidden" name="action" value="MassSave" />
            <input type="hidden" name="mode" value="MassDeleteUsers" />
            <input type="hidden" name="userRequestMode" value="{$PERMANENT}" />
            <div name='massEditContent'>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                       ...
                       {*12.6.20 *}
                           <select class="select2 {if $OCCUPY_COMPLETE_WIDTH} row-fluid {/if}" name="tranfer_owner_id" data-validation-engine="validate[ required]"  style = "width:100% !important;">
