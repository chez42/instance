...
<div id="authorize-net-info" class="relatedContainer">
    ...
    <div class="row-fluid customer-profile">
        ...
        <div class="span12">
            {if $RECORD_EXISTED eq 1}
                ...
                <a href="javascript:void(0);" class="an-c-profile" data-url="index.php?module=ANCustomers&view=EditCustomerProfileAjax&record={$RECORD.ancustomersid}&account_id={$ACCOUNT_ID}" data-record="{$RECORD.ancustomersid}" style="color: #15c; text-decoration: underline;">
            ...
            {else}
                ...
                <a href="javascript:void(0);" class="an-c-profile" data-url="index.php?module=ANCustomers&view=EditCustomerProfileAjax&account_id={$ACCOUNT_ID}" data-record="" style="color: #15c; text-decoration: underline;">
    ...
    <div class="row-fluid payment-profiles">
        ...
        <div class="span12 list-payment-profile">
            ...
            {foreach item=PAYMENT_PROFILE from=$PAYMENT_PROFILES}
                ...
                {if $PAYMENT_PROFILE.payment_method eq 'CreditCardSimpleType'}
                    ...
                    <a href="javascript:void(0);" class="add-payment-profile" data-url="index.php?module=ANPaymentProfile&view=EditPaymentProfileAjax&account_id={$ACCOUNT_ID}&customerprofileid={$RECORD.ancustomersid}&record={$PAYMENT_PROFILE.anpaymentprofileid}" style="color: #15c; text-decoration: underline;">
                        {vtranslate('LBL_AN_CUSTOMER_PROFILE_VIEW', $MODULE)}
                    </a>
                {/if}
        ...
        <div class="span12 add-payment-profile">
            <a href="javascript:void(0);" class="add-payment-profile" data-url="index.php?module=ANPaymentProfile&view=EditPaymentProfileAjax&account_id={$ACCOUNT_ID}&customerprofileid={$RECORD.ancustomersid}&record=" style="color: #15c; ">
