        ...
        <div class = "row">
                ...
                {if count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
                    <div class="btn-group listViewMassActions" role="group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="hide"><a id="{$MODULE}_listView_advancedAction_CALCULATE_BILLING"  href="javascript:void(0);" onclick='Vtiger_List_Js.triggerCalculateBilling()'>{vtranslate('LBL_CALCULATE_BILLING', $MODULE)}</a></li>
            ...
            <div class='col-md-6'>
                ...
                <div style="font-size:15px;">
                	<center><strong> Total Accounts : {$TOTAL_ACCOUNTS} &nbsp;&nbsp;&nbsp; Total Assests : {CurrencyField::appendCurrencySymbol(number_format($TOTAL_ASSESTS,2), $USER_MODEL->get('currency_symbol'))} </strong></center>
                </div>
            </div>
            <div class="col-md-3">
