        ...
        <table class="table" style="display:block; width:100%;"  border="0">
            ...
            {foreach from=$ytd_individual_performance_summed key=account_number item=v}
                <tr {if $ytd_individual_performance_summed[$account_number]['Flow']->disable_performance eq 1} style="{*background-color:#FFFFE0;*}" {/if}>
                    ...
                    <td><span style="text-align:left; float:left;width:10%;">$</span><span style="text-align:right; float:right;width:90%;">{$ytd_performance_summed.Income->amount|number_format:2:".":","}</span></td>
            ...
            <tr>
                ...
                <td style="text-align:right; background-color:RGB(245, 245, 245); font-weight:bold;"><span style="text-align:left; float:left;width:10%;">$</span><span style="text-align:right; float:right;width:90%;">{$ytd_performance_summed.Income->amount|number_format:2:".":","}</span></td>
    ...
    <div class="GHReport_section">
        ...
        <table class="table" border="0">
            ...
            <tr>
                ...
                <td style="text-align:right; font-weight:bold;">{$ytd_twr[$account_number]|number_format:2:".":","}%</td>
