...
{*        <th style="font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:center">Investment Gain (%)</th>*}
    ...
    <tbody>
    <tr>
        <td colspan="9" style="font-weight:bold; background-color:RGB(245, 245, 245);">Trailing 3 ({$T3PERFORMANCE->GetStartDate()} to {$T3PERFORMANCE->GetEndDate()})</td>
    </tr>
...
{*            <td style="text-align:right;">{$t3_appreciation_percent[$account_number]|number_format:2:".":","}%</td>*}
    ...
    {/foreach}
    <tr>
        <td colspan="9" style="font-weight:bold; background-color:RGB(245, 245, 245);">Year to Date ({$T6PERFORMANCE->GetStartDate()} to {$T6PERFORMANCE->GetEndDate()})</td>
    </tr>
...
{*            <td style="text-align:right;">{$t6_appreciation_percent[$account_number]|number_format:2:".":","}%</td>*}
    ...
    {/foreach}
    <tr>
        <td colspan="9" style="font-weight:bold; background-color:RGB(245, 245, 245);">Trailing 12 ({$T12PERFORMANCE->GetStartDate()} to {$T12PERFORMANCE->GetEndDate()})</td>
    </tr>
