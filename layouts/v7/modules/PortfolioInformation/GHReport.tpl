...
{*                        {if $UNSETTLED_CASH eq 0}
                        ...
                        {else}
                            <tr>
                                <td><strong>Unsettled Cash</strong></td>
                                <td style="text-align:right;">${$UNSETTLED_CASH|number_format:2:".":","}</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td style="text-align:right; border-top:1px solid black; padding-top:10px;">${$SETTLED_TOTAL|number_format:2:".":","}</td>
                                <td>&nbsp;</td>
                            </tr>
                        {/if}*}
                        </tbody>
