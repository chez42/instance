...
{if $HOLDINGSPIEVALUES neq ''} 

	<script src="{$SITEURL}layouts/v7/lib/jquery/jquery.min.js"></script>
	<script src="{$SITEURL}libraries/amcharts4/core.js"></script>
	<script src="{$SITEURL}libraries/amcharts4/charts.js"></script>
	<script src="{$SITEURL}libraries/amcharts4/themes/animated.js"></script>
	...
	<script type="text/javascript">
		...
		function ValuePieChart(){
			...
			var pieSeries = chart.series.push(new am4charts.PieChart3D());
