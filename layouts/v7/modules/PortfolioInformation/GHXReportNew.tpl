    ...
    <div class="GHReport_section">
        ...
        <table class="table" style="display:block; width:100%;">
            ...
            <tr>
                ...
                <th style="font-size: 12px; font-weight:bold; background-color:RGB(245, 245, 245); width:15%; text-align:right; text-decoration:underline;">BEG. BALANCE</th>
                <th style="font-size: 12px; font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:right; text-decoration:underline;">ADDTNS/ WTHDRWLS</th>
                <th style="font-size: 12px; font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:right; text-decoration:underline;">CHANGE IN VALUE</th>
                {*                <th style="font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:center">Expenses</th>*}
                <th style="font-size: 12px; font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:right; text-decoration:underline;">END BALANCE</th>
                <th style="font-size: 12px; font-weight:bold; background-color:RGB(245, 245, 245); width:5%; text-align:right; text-decoration:underline;">ESTIMATED INCOME</th>
    ...
    <div class="GHReport_section">
        ...
        <table class="table" border="0">
            ...
            {foreach key=k item=v from=$SELECTED_INDEXES}
                <tr>
                    <td>{$v.security_symbol}{if $v.description neq $v.security_symbol} - {$v.description}{/if}</td>
                    <td style="text-align:right; font-weight:bold;" colspan="3">{$YTDPERFORMANCE->GetIndex({$v.security_symbol})|number_format:2:".":","}%</td>
                </tr>
            {/foreach}{*
            <tr>
                <td>S&amp;P 500</td>
