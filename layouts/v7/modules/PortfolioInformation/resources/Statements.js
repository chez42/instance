...
jQuery.Class("Statements_Module_Js",{
    ...
    ClickEvents: function(){
        ...
        $(".index_list tbody tr").click(function(){
            ...
            $.post("index.php", {module:'PortfolioInformation', action:'Indexes', todo:'save_preferences', preferred_ids:self.preferred_ids}, function(response){
