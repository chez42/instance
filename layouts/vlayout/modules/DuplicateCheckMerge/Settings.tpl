    ...
    <div class="dupecheck-setting row-fluid">
        <div class="span12 select-modules" style="text-align: center; padding: 5px 0;">
            <button type="button" class="btn btn-primary" onclick="dcmAddModule(this)">
                <h3 style="color: #fff;">{vtranslate('SELECT_THE_MODULES', $MODULE_LBL)}</h3>
            </button>
        </div>
        ...
        {foreach item=MODULE_SETTING key=MODULE_SETTING_NAME from=$MODULE_SETTINGS}
            <div class="list-module-block">
                <div class="span12"  style="width: 95%; padding: 10px 0 10px; border-top: 1px dotted #CCC; margin: 20px 0 0; text-align: center;">
                ...
                <div class="span12" style="width: 95%;">
                    <table width="100%" cellpadding="5">
                        <thead>
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="javascript:infoPopup('layouts/vlayout/modules/DuplicateCheckMerge/info/cross_check.html')">
                                ...
                                <td align="center">
                                    ...
                                    <a href="javascript:infoPopup('layouts/vlayout/modules/DuplicateCheckMerge/info/realtime_asyoutype.html')">
                                        <img src="layouts/vlayout/modules/DuplicateCheckMerge/resources/info.png" title="More info" />
                                    </a>
                                </td>
                                <td align="center">
                                    {vtranslate('REAL_TIME_OPENING_THE_RECORD_LBL', $MODULE_LBL)}
                                    <a href="javascript:infoPopup('layouts/vlayout/modules/DuplicateCheckMerge/info/realtime_openingtherecord.html')">
                                        <img src="layouts/vlayout/modules/DuplicateCheckMerge/resources/info.png" title="More info" />
                                    </a>
                                </td>
                                <td align="center">
                                    {vtranslate('PASSIVE_CLICKING_THE_ICON_LBL', $MODULE_LBL)}
                                    <a href="javascript:infoPopup('layouts/vlayout/modules/DuplicateCheckMerge/info/passive.html')">
                                        <img src="layouts/vlayout/modules/DuplicateCheckMerge/resources/info.png" title="More info" />
                                    </a>
                                </td>
                                <td align="center">
                                    {vtranslate('DUPLICATE_MERGE_LBL', $MODULE_LBL)}
                                    <a href="javascript:infoPopup('layouts/vlayout/modules/DuplicateCheckMerge/info/duplicatemerge.html')">
                                        <img src="layouts/vlayout/modules/DuplicateCheckMerge/resources/info.png" title="More info" />
                                    </a>
                                </td>
                                <td></td>
                        ...
                        {if $MODULE_SETTING.fields|@count gt 0}
                            ...
                            <tr>
                                <td valign="top">
                                    <select class="chzn-select list-fields" data-modulename="{$MODULE_SETTING_NAME}" name="dcm_setting[{$MODULE_SETTING_NAME}][fields][]">
                                ...
                                <td align="center" valign="top">
                                    <select name="dcm_setting[{$MODULE_SETTING_NAME}][crosscheck][{$field}][]" data-placeholder="{vtranslate('SELECT_SOME_OPTIONS_CROSSCHECK', $MODULE_LBL)}" multiple class="chzn-select crosscheck" style="width: 250px;">
                                ...
                                <td align="center" valign="top">
                                    <select name="dcm_setting[{$MODULE_SETTING_NAME}][rtayt][]" class="chzn-select" style="width: 75px;">
                                ...
                                <td align="center" valign="top">
                                    <select name="dcm_setting[{$MODULE_SETTING_NAME}][rtotr][]" class="chzn-select real-time-opening-the-record" style="width: 75px;">
                                ...
                                <td align="center" valign="top">
                                    <select name="dcm_setting[{$MODULE_SETTING_NAME}][passive][]" class="chzn-select passive" style="width: 75px;" {if $MODULE_SETTING.fields.rtotr[$i] eq 1}disabled{/if}>
                                ...
                                <td align="center" valign="top">
                                    <select name="dcm_setting[{$MODULE_SETTING_NAME}][duplicate_merge][]" class="chzn-select" style="width: 75px;">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="6">
                                    <button class="btn addButton" type="button" onclick="addNewField(this,list_field_{$MODULE_SETTING_NAME}, '{$MODULE_SETTING_NAME}'); return false;">
...
<script type="text/javascript">
        ...
        jQuery.ajax({
            ...
            success:function (response) {
                if(response.result.success){
                    app.showModalWindow(response.result.data);
                }
            }
        });
    }
    ...
    function addNewField(obj, list_field, module_name){
        ...
        var cross_check = '<select name="dcm_setting['+module_name+'][crosscheck]['+list_field_first.val()+'][]" multiple class="chzn-select crosscheck" style="width: 250px;">';
        ...
        field_row +=         '<select class="chzn-select" name="dcm_setting['+module_name+'][rtayt][]" style="width: 75px;">';
        field_row +=            '<option value="1">Yes</option>';
        field_row +=            '<option value="0">No</option>';
        field_row +=         '</select>';
        field_row +=     '</td>';
        field_row +=     '<td align="center">';
        field_row +=         '<select class="chzn-select real-time-opening-the-record" name="dcm_setting['+module_name+'][rtotr][]" style="width: 75px;">';
        field_row +=            '<option value="1">Yes</option>';
        field_row +=            '<option value="0">No</option>';
        field_row +=         '</select>';
        field_row +=     '</td>';
        field_row +=     '<td align="center">';
        field_row +=         '<select class="chzn-select passive" name="dcm_setting['+module_name+'][passive][]" disabled style="width: 75px;">';
        field_row +=            '<option value="1">Yes</option>';
        field_row +=            '<option value="0" selected>No</option>';
        field_row +=         '</select>';
        field_row +=     '</td>';
        field_row +=     '<td align="center">';
        field_row +=         '<select class="chzn-select" name="dcm_setting['+module_name+'][duplicate_merge][]" style="width: 75px;">';
        field_row +=            '<option value="1">Yes</option>';
        field_row +=            '<option value="0">No</option>';
        field_row +=         '</select>';
        field_row +=     '</td>';
    ...
    jQuery(document).ready(function(){
        jQuery(document).on('change', '.real-time-opening-the-record', function() {
            ...
            passiveElement.trigger("liszt:updated");
        });
        jQuery(document).on('change', '.list-fields', function() {
            ...
            crosscheck.trigger("liszt:updated");
        });
    });
</script>
{/literal}
