...
jQuery.Class("DuplicateCheckMerge_Settings_Js",{
    editInstance:false,
    getInstance: function(){
        if(DuplicateCheckMerge_Settings_Js.editInstance == false){
            var instance = new DuplicateCheckMerge_Settings_Js();
            DuplicateCheckMerge_Settings_Js.editInstance = instance;
            return instance;
        }
        return DuplicateCheckMerge_Settings_Js.editInstance;
    }
},{
