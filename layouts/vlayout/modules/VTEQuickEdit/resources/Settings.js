 ...
 * All Rights Reserved.
 * ****************************************************************************** */
jQuery.Class("VTEQuickEdit_Settings_Js",{
        ...
        jQuery('#status').change(function() {
            ...
            AppConnector.request(params).then(
                function(data) {
                    progressIndicatorElement.progressIndicator({'mode' : 'hide'});
                    var params_massage = {};
                    if(status) params_massage.text = app.vtranslate('VTEQuickEdit enabled');
                    else params_massage.text = app.vtranslate("VTEQuickEdit disabled");
