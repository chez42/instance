	...
	<table class="table table-bordered listViewEntriesTable">
		<thead>
			<tr class="listViewHeaders">
                ...
                <th nowrap colspan="2" style="width: 70%">
            ...
            <td class="medium" nowrap="">
                <div class="pull-right actions">
                    <span class="actionImages">
                       <a href="index.php?module=VTEConditionalAlerts&parent=Settings&view=Edit&record={$LISTVIEW_ENTRY['id']}">
                            <i class="icon-pencil alignMiddle" title="Edit"></i>
                       </a>
                       <a href="javascript:void(0);" class="removeCLF" data-id = {$LISTVIEW_ENTRY['id']}>
