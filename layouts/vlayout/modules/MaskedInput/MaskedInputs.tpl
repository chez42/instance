                ...
                <td nowrap class="{$WIDTHTYPE}">
                    <div class="actions pull-right">
                            <span class="actionImages">
                                    <a href='javascript: void(0);' class="editRecordButton" data-url="index.php?module=MaskedInput&view=EditAjax&mode=getCustomInputForm&record={$ID}"><i title="{vtranslate('LBL_EDIT')}" class="icon-pencil alignMiddle"></i></a>&nbsp;
