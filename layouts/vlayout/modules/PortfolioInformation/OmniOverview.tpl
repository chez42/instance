...
<div id="overview_charts" style="display:block; width:100%;">
    <div id="dynamic_pie_holder" class="dynamic_pie_holder" style="height: 300px; width:450px; float:left;"></div>
    <div id="dynamic_chart_holder" class="dynamic_chart_holder" style="height: 300px; width:450px; float:right;"></div>
</div>
...
<table id="overview_performance" class="collap_performance table table-bordered">
    <thead>
        <tr>
            ...
            <th style="font-weight:bold;">Trailing 3<br />({$T3PERFORMANCE->GetStartDate()} to {$T3PERFORMANCE->GetEndDate()})</th>
            <th style="font-weight:bold;">Year to Date<br />({$T6PERFORMANCE->GetStartDate()} to {$T6PERFORMANCE->GetEndDate()})</th>
            <th style="font-weight:bold;">Trailing 12<br />({$T12PERFORMANCE->GetStartDate()} to {$T12PERFORMANCE->GetEndDate()})</th>
        </tr>
    </thead>
    <tbody>
