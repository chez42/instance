<div class="PortfolioInformationAssetAllocationReport">
                ...
                <div class=" span12 ">
                    ...
                    <div class=" span8 ">
                        <div id="dynamic_pie">
                            ...
                            <div id="dynamic_pie_holder" class="report_top_pie" style="height: 320px; display:block; width:50%; float:left;"></div>
                            <div id="dynamic_pie_legend" class="dynamic_pie_legend" style="height:320px; display:block; width:10%; float:left;"></div>
                            <div style="width:20%; display:block; float:left;"></div>
                        </div>
                    </div>
                    <div class=" span2 ">&nbsp;</div>
