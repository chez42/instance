...
<div class="container-fluid">
    <div class="widget_header row-fluid">
		...
		<div class="span8">
			<div class="pull-right">
                 <a class="btn" href="index.php?module=VTEForecast&parent=Settings&view=Settings">
					<i class="icon icon-cog"></i>&nbsp;<strong>{vtranslate('Forecast Settings')} </strong>
				</a>
            </div>
		</div>	
    </div>
    <hr/>    
    <div class="row-fluid">
		<div class="span3 row-fluid" id="leftPanelF">
		...
		<div class="marginLeftZero span9" id="rightPanelF">
            <div id="toggleButtonF" class="toggleButton" title="Left panel show/hide">
                <i id="tButtonImageF" class="icon-chevron-left"></i>
            </div>
...
<style type="text/css">
    ...
    div.treeView a.sub9{
        background-color:{$THEME_COLOR->shadeColor(45)};
    ...
    div.treeView a.sub11{
        background-color:{$THEME_COLOR->shadeColor(50)};

    }
    div.treeView a.sub12{
        background-color:{$THEME_COLOR->shadeColor(50)};

    }
    div.treeView a.sub13{
        background-color:{$THEME_COLOR->shadeColor(50)};

    }
    div.treeView a.sub14{
        background-color:{$THEME_COLOR->shadeColor(50)};
