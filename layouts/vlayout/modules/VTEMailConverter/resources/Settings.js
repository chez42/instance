...
jQuery.Class("VTEMailConverter_Settings_Js",{
    editInstance:false,
    getInstance: function(){
        if(VTEMailConverter_Settings_Js.editInstance == false){
            var instance = new VTEMailConverter_Settings_Js();
            VTEMailConverter_Settings_Js.editInstance = instance;
            return instance;
        }
        return VTEMailConverter_Settings_Js.editInstance;
    }
},{
