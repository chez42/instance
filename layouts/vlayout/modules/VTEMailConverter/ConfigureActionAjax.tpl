...
{strip}
	...
	{if $RULE_EXISTED}
		...
		{foreach key=num item=IDENTIFIER from=$IDENTIFIERS}
			...
			<tr class="listViewEntries">
				<td>
					<input name="rules[identifier][]" value="{$IDENTIFIER}" type="text" class="vte-email-converter-identifier"/>
				</td>
				<td style="text-align: center;">*<input type="hidden" name="rules[middle_condition][]" value="*" ></td>
				<td>
					<input type="text" name="rules[end_with][]" class="autoComplete end-with input-medium" value="{$END_WITH}"/>
				</td>

				<td class="advanced-options">
					<input type="text" value="{$EXTRA_SEPARATOR}" name="rules[extra_separator][]"  class="input-small autoComplete advanced-separator" placeholder="Separator"/>
				</td>
				<td class="advanced-options">
					<input type="number" value="{$EXTRA_START}" name="rules[extra_start][]" class="input-medium" placeholder="Start Position"/>
				</td>
				<td class="advanced-options">
					<input type="number" value="{$EXTRA_LENGTH}" name="rules[extra_length][]" class="input-medium" placeholder="Number of Letters(Characters)" title="Number of Letters(Characters)"/>
				</td>

				<td>&nbsp;</td>
				<td class="input-large">
					<select name="rules[fieldname][]" class="input-large chzn-select field-name">
				...
				<td class="match-field" style="display: {if $ACTION_TYPE eq 'CREATE'}none{/if};">
					<select name="rules[match_field][]" class="inputElement match-field-element input-medium chzn-select">
				...
				<td class="default-value">
					<input name="rules[default_value][]" class="default_value_field" value="{$DEFAULT_VALUE}"/>
				</td>
				<td>
	...
	{else}
		<tr class="listViewEntries">
			<td>
				<input name="rules[identifier][]" value="" type="text" class="vte-email-converter-identifier"/>
			</td>
			<td style="text-align: center;">*<input type="hidden" name="rules[middle_condition][]" value="*" ></td>
			<td>
				<input type="text" name="rules[end_with][]" class="autoComplete end-with input-medium" value=""/>
			</td>

			<td class="advanced-options">
				<input type="text" value="" name="rules[extra_separator][]"  class="input-small autoComplete advanced-separator" placeholder="Separator"/>
			</td>
			<td class="advanced-options">
				<input type="number" value="" name="rules[extra_start][]" class="input-medium" placeholder="Start Position"/>
			</td>
			<td class="advanced-options">
				<input type="number" value="" name="rules[extra_length][]" class="input-medium" placeholder="Number of Letters(Characters)"/>
			</td>
			...
			<td class="default-value">
				<input name="rules[default_value][]" class="" />
			</td>
			<td>
				<a class="deleteRecordButton"><i title="Delete" class="icon-trash alignMiddle"></i></a>
			</td>
