        ...
        <div class="summaryWidgetContainer">
            <ul class="nav nav-tabs massEditTabs">
                {foreach from=$SETTINGS name=SETTING_NAME  key=MODULE item=SETTING}
                    <li {if $smarty.foreach.SETTING_NAME.first} class="active" {/if}>
                    ...
                    <div class="tab-pane moduleTab  {if $smarty.foreach.SETTING_NAME.first}active{/if}" id="module_{$MODULE}">
                        <div class="row-fluid">
                            <div class="span6">
                                ...
                                <ul class="nav nav-pills " style="display:  block; margin-top: 10px; margin-bottom:0;">
                                    ...
                                    <li><a href="#sectionTab_{$MODULE}"  data-toggle = "pill"><strong>{vtranslate('LBL_SECTIONS', $QUALIFIED_MODULE)}</strong></a></li>
                                </ul>
                            </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane totalTab" id="totalsTab_{$MODULE}">
                                <div class="row-fluid fieldTotalContainer" style="width: 70%; padding: 10px;" >
                                            ...
                                            {else}
                                                {foreach item = SECTION_VALUE from=$SECTION_VALUES}
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="sectionValue" data-validation-engine="validate[required]" value="{$SECTION_VALUE}"></td>
                                                    </tr>
                                                {/foreach}
                                            {/if}
