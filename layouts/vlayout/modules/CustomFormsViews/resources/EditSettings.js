 ...
 * All Rights Reserved.
 * ****************************************************************************** */
jQuery.Class("CustomFormsViews_EditSettings_Js",{
    editInstance:false,
    ...
    registerSetBlockVisible:function() {
        var thisInstance = this;
        var blockVisibility = jQuery('#field_blocks').find('.blockVisibility>a');
        blockVisibility.click(function(e) {
            ...
            if(oldDisplayStatus == '0') {
                jQuery(this).find('.icon-ok').removeClass('hide');
                blockParent.data('visible', '1');
            } else {
                jQuery(this).find('.icon-ok').addClass('hide');
