...
if (!$adb->num_rows($sel)) {
    ...
    $field1  = new Vtiger_Field();
    $field1->name = 'group_no';
    $field1->label= 'Group No';
    $field1->uitype= 4;
    $field1->column = $field1->name;
    $field1->columntype = 'VARCHAR(255)';
    $field1->typeofdata = 'V~O';
    ...
    $field2  = new Vtiger_Field();
    $field2->name = 'group_name';
    $field2->label= 'Group Name';
    $field2->uitype= 2;
    $field2->column = $field2->name;
    ...
    $field3 = new Vtiger_Field();
    $field3->name = 'household';
    $field3->label= 'Household Account';
    $field3->uitype = 10;
    $field3->column = $field3->name;
...
$notifyWorkflowTask = $adb->pquery("SELECT * FROM com_vtiger_workflow_tasktypes WHERE classname = 'NotificationTask' AND tasktypename='NotificationTask'");
if(!$adb->num_rows($notifyWorkflowTask)){
    $taskId = $adb->query_result(
        $adb->pquery("SELECT MAX(id) as maxno FROM com_vtiger_workflow_tasktypes"), 0, 'maxno'
    )+1;
    $adb->pquery("INSERT INTO com_vtiger_workflow_tasktypes (id, tasktypename, label, classname, classpath, templatepath, modules, sourcemodule) 
