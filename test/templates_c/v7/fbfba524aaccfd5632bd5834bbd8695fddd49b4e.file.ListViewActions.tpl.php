<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:26:21
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Vtiger\ListViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:196595ee9c59d5d11f5-83892127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbfba524aaccfd5632bd5834bbd8695fddd49b4e' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Vtiger\\ListViewActions.tpl',
      1 => 1589643819,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '196595ee9c59d5d11f5-83892127',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c59d72254',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c59d72254')) {function content_5ee9c59d72254($_smarty_tpl) {?>
...
" disabled="disabled" tippytitle ><i class="material-icons">create</i></button><?php }?><?php if ($_smarty_tpl->tpl_vars['deleteAction']->value){?><button type="button" class="btn btn-danger" id=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" disabled="disabled" tippytitle ><i class="material-icons">delete</i></button><?php }?><?php if ($_smarty_tpl->tpl_vars['commentAction']->value){?><button type="button" class="btn btn-info" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" disabled="disabled" tippytitle ><i class="material-icons">comment</i></button><?php }?><?php if (count($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value)>0||count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW'])>0){?><div class="btn-group listViewMassActions" role="group"><button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"><?php echo vtranslate('LBL_MORE','Vtiger');?>
&nbsp;<i class="material-icons">arrow_drop_down</i></button><ul class="dropdown-menu" role="menu"><?php  $_smarty_tpl->tpl_vars['LISTVIEW_MASSACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_MASSACTION']->_loop = false;
...
</a> </div><?php }?><?php }?><?php }?><div class="hide alert alert-success messageContainer" style = "margin-top:20px;"><center><a href="#" id="selectAllMsgDiv"><?php echo vtranslate('LBL_SELECT_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;(<span id="totalRecordsCount" value=""></span>)</a></center></div><div class="hide alert alert-warning messageContainer"  style = "margin-top:20px;"><center><a href="#" id="deSelectAllMsgDiv"><?php echo vtranslate('LBL_DESELECT_ALL_RECORDS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></center></div></div></div></div><?php }} ?>