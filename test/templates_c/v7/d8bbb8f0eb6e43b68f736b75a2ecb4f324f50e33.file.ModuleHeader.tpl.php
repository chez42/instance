<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:19:07
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Calendar\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:228995ee9c3ebbbe012-64345604%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8bbb8f0eb6e43b68f736b75a2ecb4f324f50e33' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Calendar\\ModuleHeader.tpl',
      1 => 1589643805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '228995ee9c3ebbbe012-64345604',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3ebca55c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3ebca55c')) {function content_5ee9c3ebca55c($_smarty_tpl) {?>
...
')"<?php }?>><div class="ti-import" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
"'<?php }?>><div class="ti-plus" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></li><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="ti-settings" aria-hidden="true" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
