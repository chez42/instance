<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:19:08
         compiled from "D:\xampp\htdocs\omni-live\layouts\v7\modules\Vtiger\uitypes\Recurrence.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162205ee9c3ec25f557-75759860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e63ace44335e4820cf00d1deca775ed81470b104' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\v7\\modules\\Vtiger\\uitypes\\Recurrence.tpl',
      1 => 1590764870,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162205ee9c3ec25f557-75759860',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3ec311ce',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3ec311ce')) {function content_5ee9c3ec311ce($_smarty_tpl) {?>
...
' value="" <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['recurringcheck']=='Yes'){?>checked<?php }?>/>&nbsp;&nbsp;</div><br><div class="" id="repeatUI" style="display: <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['recurringcheck']=='Yes'){?>block<?php }else{ ?>none<?php }?>;"><div class="row"><div class="col-md-3"><span class="alignMiddle"><?php echo vtranslate('LBL_REPEATEVENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;</span></div><div class="col-md-2"><select class="select2 input-mini recurring_select" name="repeat_frequency"><?php $_smarty_tpl->tpl_vars['FREQUENCY'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['FREQUENCY']->step = 1;$_smarty_tpl->tpl_vars['FREQUENCY']->total = (int)ceil(($_smarty_tpl->tpl_vars['FREQUENCY']->step > 0 ? 14+1 - (1) : 1-(14)+1)/abs($_smarty_tpl->tpl_vars['FREQUENCY']->step));
...
</option><?php }} ?></select></div><div class="col-md-3"><select class="select2 input-medium recurring_select" style="width:100px;margin-left: 10px;" name="recurringtype" id="recurringType"><option value="Daily" <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['eventrecurringtype']=='Daily'){?> selected <?php }?>><?php echo vtranslate('LBL_DAYS_TYPE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option></select></div></div><div class="row <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['eventrecurringtype']=='Weekly'){?>show<?php }else{ ?>hide<?php }?>"  id="repeatWeekUI" style="margin:10px 0;"><div class="col-lg-2"><span class="medium" style="padding-left:23px"><?php echo ucwords(vtranslate('LBL_ON',$_smarty_tpl->tpl_vars['MODULE']->value));?>
</span></div><div class="col-lg-10"><label class="checkbox" style="margin-left: 30px;display: inline;"><input name="sun_flag" value="sunday" <?php echo $_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['week0'];?>
...
</label></div></div><div class="<?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['eventrecurringtype']=='Monthly'){?>show<?php }else{ ?>hide<?php }?>" id="repeatMonthUI" style="margin-top:10px;"RCa><div class="row"><div class="col-lg-4"><div class="pull-right"><input type="radio" id="repeatDate" data-field-id= '<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
...
</span></div></div><div class="col-lg-8"><input type="text" id="repeatMonthDate" data-field-id= '<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
...
</span></div><div class="clearfix"></div></div><div class="row" id="repeatMonthDayUI" style="margin-top: 10px;"><div class="col-lg-4"><div class="pull-right"><input type="radio" id="repeatDay" data-field-id= '<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('id');?>
...
</span></div></div><div class="col-lg-2"><select id="repeatMonthDayType" class="select2" name="repeatMonth_daytype" style="width: 90px;"><option value="first" <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['repeatMonth_daytype']=='first'){?> selected <?php }?>><?php echo vtranslate('LBL_FIRST',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option></select></div><div class="col-lg-6 margin0"><select id="repeatMonthDay" class="select2 recurring_select" name="repeatMonth_day" style="width: 120px;"><option value=0 <?php if ($_smarty_tpl->tpl_vars['RECURRING_INFORMATION']->value['repeatMonth_day']==0){?> selected <?php }?>><?php echo vtranslate('LBL_DAY0',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option></select></div></div></div><div class="row" style="margin-top:10px;"><div class="col-md-3"><span class="alignMiddle displayInlineBlock">&nbsp;&nbsp;<?php echo vtranslate('LBL_UNTIL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></div><div class="col-md-9"><span class="input-group date  inputElement recurring_date"><input type="text" id="calendar_repeat_limit_date" class="dateField input-small form-control" name="calendar_repeat_limit_date" data-date-format="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format');?>
...
<?php }?>"data-rule-date="true" data-rule-required="true"/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></span></div></div></div></div><?php }} ?>