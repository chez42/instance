<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:26:21
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Calendar\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:225975ee9c59d2693e1-43166271%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c7617953db4d581c0fcaa816402200392f62b15' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Calendar\\ListViewContents.tpl',
      1 => 1589643805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '225975ee9c59d2693e1-43166271',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c59d51cf7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c59d51cf7')) {function content_5ee9c59d51cf7($_smarty_tpl) {?>
...
<div class="col-sm-12 col-xs-12 ">
	<?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='EmailTemplates'&&$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value!=true){?>
		...
		<div class="essentials-toggle hidden-sm hidden-xs" title="<?php echo vtranslate('LBL_LEFT_PANEL_SHOW_HIDE','Vtiger');?>
">
			<span class="essentials-toggle-marker fa <?php if ($_smarty_tpl->tpl_vars['LEFTPANELHIDE']->value=='1'){?>fa-chevron-left<?php }else{ ?>fa-chevron-right<?php }?> cursorPointer"></span>
		</div>
	<?php }?>
...
' />
	...
	<div id="table-content" class="table-container" >
		<form name='list' id='listedit' action='' onsubmit="return false;" >
			<table  id="listview-table" class="table table-striped table-hover <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?>listview-table-norecords <?php }?> listview-table ">
				<thead>
					...
					<div class="table-actions">
						<div style="float:left;">
							<span class="input" title="<?php echo vtranslate('LBL_CLICK_HERE_TO_SELECT_ALL_RECORDS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
">
...
"
				...
				<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=="Contacts"||$_smarty_tpl->tpl_vars['MODULE']->value=="Products"){?><th style="width:25px;">&nbsp;</th><?php }?>
...
">
					...
					<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=="Contacts"||$_smarty_tpl->tpl_vars['MODULE']->value=="Products"){?>
					<td>				
					<?php $_smarty_tpl->tpl_vars['IMAGE_DETAILS'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getImageDetails(), null, 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['path'])&&!empty($_tmp1)){?>
					<a class="thumbnailz" href="#thumb"><img src="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['path'];?>
_<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
" style="width:30px;height:30px;border-radius:50%;" />
					<span><img src="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['path'];?>
_<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
" style="width:300px;border-radius:0;"></span></a>
							<?php }else{ ?>
								<img src="layouts/rainbow/skins/images/DefaultUserIcon.png"  style="width:30px;height:30px;border-radius:50%;" >
							<?php }?>
						<?php } ?>
						<?php if (empty($_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value)){?>
							<img src="layouts/rainbow/skins/images/DefaultUserIcon.png"  style="width:30px;height:30px;border-radius:50%;">
						<?php }?>
...
?>
						...
						<td class="listViewEntryValue <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='72'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='71'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='70'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='5'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='23'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='6'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='7'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='9'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('typeofdata')=='N~O'){?>text-right<?php }?>" 
						data-name="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name');?>
...
"
						<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')!='createdtime'&&$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')!='modifiedtime'){?>nowrap<?php }?>>
...
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CURRENCY_SYMBOL_PLACEMENT'] = new Smarty_variable($_tmp2, null, 0);?>
...
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp5, null, 0);?>
												...
												<?php }else{ ?>
													<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getId();?>
<?php $_tmp6=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp6, null, 0);?>
												<?php }?>
											<?php }?>
...
"<?php }?> > 
							...
							<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isAjaxEditable()=='true'&&$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()!='contact_id'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='activitytype'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='eventstatus'){?>
...
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['COLSPAN_WIDTH'] = new Smarty_variable($_tmp7+1, null, 0);?>
