<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:59
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Calendar\CalendarViewTypes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:235235ee9c3e3281e39-12917345%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '661d62187c333877490b34978231a6fa6b59f3de' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Calendar\\CalendarViewTypes.tpl',
      1 => 1589643805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '235235ee9c3e3281e39-12917345',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3e32e687',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3e32e687')) {function content_5ee9c3e32e687($_smarty_tpl) {?>

<style>.mCustomScrollBox {max-height: min-content !important;}</style><div class="sidebar-widget-contents" name='calendarViewTypes'><div id="calendarview-feeds"><ul class="list-group feedslist"><?php  $_smarty_tpl->tpl_vars['VIEWINFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['VIEWINFO']->_loop = false;
...
"data-calendar-feed-textcolor="white" data-calendar-typeid="<?php echo $_smarty_tpl->tpl_vars['VIEWINFO']->value['typeid'];?>
"data-calendar-feed-conditions='<?php echo $_smarty_tpl->tpl_vars['VIEWINFO']->value['conditions']['rules'];?>
' />&nbsp;&nbsp;<i class="material-icons editCalendarFeedColor cursorPointer">create</i>&nbsp;&nbsp;<i class="material-icons deleteCalendarFeed cursorPointer">delete</i></span></li><?php } ?></ul><?php $_smarty_tpl->tpl_vars['INVISIBLE_CALENDAR_VIEWS_EXISTS'] = new Smarty_variable('false', null, 0);?><?php if ($_smarty_tpl->tpl_vars['ADDVIEWS']->value){?><?php $_smarty_tpl->tpl_vars['INVISIBLE_CALENDAR_VIEWS_EXISTS'] = new Smarty_variable('true', null, 0);?><?php }?><input type="hidden" class="invisibleCalendarViews" value="<?php echo $_smarty_tpl->tpl_vars['INVISIBLE_CALENDAR_VIEWS_EXISTS']->value;?>
" /><ul class="hide dummy"><li class="activitytype-indicator calendar-feed-indicator feed-indicator-template container-fluid"><span></span><span class="activitytype-actions pull-right"><input class="toggleCalendarFeed cursorPointer" type="checkbox" data-calendar-sourcekey="" data-calendar-feed=""data-calendar-feed-color="" data-calendar-fieldlabel=""data-calendar-fieldname="" title="" data-calendar-type=""data-calendar-feed-textcolor="white">&nbsp;&nbsp;<i class="material-icons editCalendarFeedColor cursorPointer">create</i>&nbsp;&nbsp;<i class="material-icons deleteCalendarFeed cursorPointer">delete</i></span></li></ul></div></div><?php }} ?>