<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:57
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Calendar\CalendarHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6085ee9c3e19f6207-20011246%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af3ef6bdb8e0f428fcdc403be56335dda0376a8e' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Calendar\\CalendarHeader.tpl',
      1 => 1592317462,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6085ee9c3e19f6207-20011246',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3e1a50a6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3e1a50a6')) {function content_5ee9c3e1a50a6($_smarty_tpl) {?>
...
"><div class="col-sm-12 col-xs-12 module-action-bar clearfix"><div class="module-action-content clearfix coloredBorderTop"><div class="col-lg-5 col-md-5"><span><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_CALENDAR_VIEW", null, 0);?><?php if ($_smarty_tpl->tpl_vars['VIEW']->value==='SharedCalendar'){?><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_SHARED_CALENDAR", null, 0);?><?php }?><a href='javascript:void(0)'><h4 class="module-title pull-left"><span style="cursor: default;"> <?php echo strtoupper(vtranslate($_smarty_tpl->tpl_vars['VIEW_HEADER_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value));?>
 </span></h4></a></span></div><div class="col-lg-7 col-md-7 pull-right"><div id="appnav" class="navbar-right"><div class="btn-group"><?php if ($_smarty_tpl->tpl_vars['IS_CREATE_PERMITTED']->value){?><button id="calendarview_basicaction_addevent" type="button"class="btn addButton module-buttons cursorPointer"onclick='Calendar_Calendar_Js.showCreateEventModal();'><div aria-hidden="true"><i class="material-icons">add</i><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_EVENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></div></button><?php if ($_smarty_tpl->tpl_vars['VIEW']->value==='SharedCalendar'||$_smarty_tpl->tpl_vars['VIEW']->value=='Calendar'){?><button id="calendarview_basicaction_print" type="button"class="btn  btn-default module-buttons cursorPointer"onclick='window.print();'><?php echo vtranslate('Print',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?><?php }?><button type="button" class="btn module-buttons dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span aria-hidden="true" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"><i class="material-icons">settings</i></span><span class="hidden-sm hidden-xs">&nbsp;&nbsp;<?php echo vtranslate('LBL_CUSTOMIZE','Reports');?>
&nbsp;</span> <span class="caret"></span></button><ul class="detailViewSetting dropdown-menu animated fadeIn"><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><?php  $_smarty_tpl->tpl_vars['SETTING'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SETTING']->_loop = false;
...
</a></li><?php }?><?php } ?><?php }?><li><a><span id="calendarview_basicaction_calendarsetting" onclick='Calendar_Calendar_Js.showCalendarSettings();' class="cursorPointer"><?php echo vtranslate('LBL_CALENDAR_SETTINGS','Calendar');?>
</span></a></li></ul></div></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
