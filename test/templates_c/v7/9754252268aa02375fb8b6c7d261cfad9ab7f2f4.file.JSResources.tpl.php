<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:21
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Vtiger\JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:301025ee9c3bd904697-92472420%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9754252268aa02375fb8b6c7d261cfad9ab7f2f4' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Vtiger\\JSResources.tpl',
      1 => 1589643819,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '301025ee9c3bd904697-92472420',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3bd93c22',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3bd93c22')) {function content_5ee9c3bd93c22($_smarty_tpl) {?>
...
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/rainbow/modules/Vtiger/resources/Vtiger.js');?>
...
"></script><script type='text/javascript' src='layouts/v7/lib/jquery/waitMe/waitMe.min.js'></script><script type="text/javascript" src="layouts/v7/lib/slick/slick.js"></script><?php  $_smarty_tpl->tpl_vars['jsModel'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['jsModel']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['SCRIPTS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['jsModel']->key => $_smarty_tpl->tpl_vars['jsModel']->value){
$_smarty_tpl->tpl_vars['jsModel']->_loop = true;
 $_smarty_tpl->tpl_vars['index']->value = $_smarty_tpl->tpl_vars['jsModel']->key;
?><?php if (vresource_url($_smarty_tpl->tpl_vars['jsModel']->value->getSrc())=='layouts/v7/modules/CustomFormsViews/resources/CustomFormsViews.js?v=7.1.0'){?><script type="<?php echo $_smarty_tpl->tpl_vars['jsModel']->value->getType();?>
" src="layouts/rainbow/modules/CustomFormsViews/resources/CustomFormsViews.js?v=7.1.0"></script><?php }elseif(vresource_url($_smarty_tpl->tpl_vars['jsModel']->value->getSrc())=='layouts/v7/modules/ControlLayoutFields/resources/ControlLayoutFields.js?v=7.1.0'){?><script type="<?php echo $_smarty_tpl->tpl_vars['jsModel']->value->getType();?>
" src="layouts/rainbow/modules/ControlLayoutFields/resources/ControlLayoutFields.js?v=7.1.0"></script><?php }else{ ?><script type="<?php echo $_smarty_tpl->tpl_vars['jsModel']->value->getType();?>
" src="<?php echo vresource_url($_smarty_tpl->tpl_vars['jsModel']->value->getSrc());?>
"></script><?php }?><?php } ?><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/resources/v7_client_compat.js');?>
...
";jQuery(document).ready(function() { window._PAGEREADYAT = new Date(); });
		...
		</script><script type="text/javascript">var child = document.getElementById("child");var parent = document.getElementById("parent");parent.addEventListener("resize", function() {if (parent.width < 90) {child.style.display = "none";}else {child.style.display = "block";}});</script><script type="text/javascript">var child = document.getElementById("child");var parent = document.getElementById("parent");parent.addEventListener("resize", function() {if (parent.width <= 80) {child.style.display = "none";}else {child.style.display = "block";}});</script><script type="text/javascript" src="layouts/rainbow/modules/Vtiger/resources/lib/perfect-scrollbar.min.js"></script><?php }} ?>