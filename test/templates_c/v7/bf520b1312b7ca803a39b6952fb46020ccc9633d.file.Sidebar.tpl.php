<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:34
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Settings\Vtiger\Sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:252725ee9c3ca03d8e9-21513943%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf520b1312b7ca803a39b6952fb46020ccc9633d' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Settings\\Vtiger\\Sidebar.tpl',
      1 => 1589985750,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '252725ee9c3ca03d8e9-21513943',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3ca0ba91',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3ca0ba91')) {function content_5ee9c3ca0ba91($_smarty_tpl) {?>
<?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><?php $_smarty_tpl->tpl_vars['SETTINGS_MODULE_MODEL'] = new Smarty_variable(Settings_Vtiger_Module_Model::getInstance(), null, 0);?><?php $_smarty_tpl->tpl_vars['SETTINGS_MENUS'] = new Smarty_variable($_smarty_tpl->tpl_vars['SETTINGS_MODULE_MODEL']->value->getMenus(), null, 0);?><div class="settingsgroup hidden-sm hidden-xs" style="margin-top: 0px; padding-top: 0px; padding-bottom: 40px"><div class="col-xs-12 text-center visible-xs visible-sm" style="margin-top: 40px;margin-bottom:20px;"><a class="btn btn-default" onclick="$('.sidebar-menu-u, .settingsNav').toggleClass('hidden-xs hidden-sm'); $('.settingsNav').find('.settingsgroup').toggleClass('hidden-xs hidden-sm');" style="width: 100%">Sidebar&nbsp;<span class="toggleButton"><i class="ti-angle-down"></i></span></a></div><div class="clearfix"></div><div><input type="text" placeholder="<?php echo vtranslate('LBL_SEARCH_FOR_SETTINGS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" class="search-list col-lg-8" id='settingsMenuSearch'></div><div class="clearfix"></div><div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"><?php  $_smarty_tpl->tpl_vars['BLOCK_MENUS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_MENUS']->_loop = false;
...
_accordion_mobile" class="app-nav" role="tab"><div class="app-settings-accordion"><div class="settingsgroup-accordion"><a data-toggle="collapse" data-parent="#accordion" class='collapsed' href="#<?php echo $_smarty_tpl->tpl_vars['BLOCK_NAME']->value;?>
_mobile"><i class="indicator <?php if ($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block']==$_smarty_tpl->tpl_vars['BLOCK_NAME']->value){?> ti-angle-down <?php }else{ ?> ti-angle-right <?php }?>"></i>&nbsp;<span><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_NAME']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></a></div></div></div><div id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_NAME']->value;?>
_mobile" class="panel-collapse collapse ulBlock <?php if ($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block']==$_smarty_tpl->tpl_vars['BLOCK_NAME']->value){?> in <?php }?>"><ul class="list-group widgetContainer"><?php  $_smarty_tpl->tpl_vars['MENUITEM'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MENUITEM']->_loop = false;
...
<i id="<?php echo $_smarty_tpl->tpl_vars['MENUITEM']->value->getId();?>
...
" class="pinUnpinShortCut cursorPointer pull-right ti-pin2" data-action="unpin"<?php }else{ ?>title="<?php echo vtranslate('LBL_PIN',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" class="pinUnpinShortCut cursorPointer pull-right ti-pin-alt" data-action="pin"<?php }?> /></i></a></li><?php } ?></ul></div></div><?php }?><?php } ?></div><div class="clearfix"></div><br><br></div><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate (myclayout_path('modules/Users/UsersSidebar.tpl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?>
<?php }} ?>