<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:26:20
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Vtiger\partials\SidebarEssentials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:298385ee9c59cf1ebd2-39543809%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2b3a475ae9f5cc9e99fb860975093513df0a656' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Vtiger\\partials\\SidebarEssentials.tpl',
      1 => 1589643821,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '298385ee9c59cf1ebd2-39543809',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c59d15c4a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c59d15c4a')) {function content_5ee9c59d15c4a($_smarty_tpl) {?>
<div class="col-xs-12 text-center visible-xs visible-sm" style="margin-bottom: 15px;">
	<a style="width: 100%; text-align: center" class="btn btn-secondary" onclick="$('.sidebar-menu').toggleClass('hidden-xs hidden-sm')">Options 
        &nbsp;<span class="toggleButton"><i class="ti-angle-down"></i></span></a><br><br><div class="clearfix"></div>
</div>
    ...
    <div class="module-filters" id="module-filters">
        <div class="sidebar-container lists-menu-container">
            <div class="sidebar-header clearfix">
                <h4 class="pull-left"><?php echo vtranslate('LBL_LISTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h4>
...
?>
                            ...
                            <div class="list-group" id="<?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value=='Mine'){?>myList<?php }else{ ?>sharedList<?php }?>">   
								...
								<h5 class="lists-header <?php if (count($_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS']->value)<=0){?> hide <?php }?>" >
...
" />
								...
								<?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value!='Mine'){?> <!-- <div class="collapse" id="shared_List"> --> <?php }?>
                                
								<div class=" menu-scroller scrollContainer" style="position:relative; top:0; left:0;" <?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value!='Mine'){?>id="sharedList"<?php }?> > 
	                               <div class="list-menu-content"> 
                                <ul class="lists-menu">
...
?>
										...
										<?php }?>
									<?php } ?>
									<li style="font-size:13px;" class='listViewFilter <?php if ($_smarty_tpl->tpl_vars['VIEWID']->value==$_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getId()&&($_smarty_tpl->tpl_vars['CURRENT_TAG']->value=='')){?> active <?php }?> '> 
                                            ...
                                            <div class="pull-right">
                                                <span class="js-popover-container" style="cursor:pointer;">
                                                    <span  class="ti-angle-down" rel="popover" data-toggle="popover" aria-expanded="true" 
		                                                <?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isMine()&&$_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('viewname')!='All'||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?>
		                                                            data-deletable="<?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isDeletable()||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?>true<?php }else{ ?>false<?php }?>" data-editable="<?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isEditable()||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?>true<?php }else{ ?>false<?php }?>" 
		                                                            <?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isEditable()||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?> data-editurl="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getEditUrl();?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isDeletable()||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?> <?php if ($_smarty_tpl->tpl_vars['SHARED_MEMBER_COUNT']->value==1||$_smarty_tpl->tpl_vars['LIST_STATUS']->value==3){?> data-shared="1"<?php }?> data-deleteurl="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getDeleteUrl();?>
"<?php }?>
                                                           <?php }?>
                                                          toggleClass="fa <?php if ($_smarty_tpl->tpl_vars['IS_DEFAULT']->value){?>ti-check-alt<?php }else{ ?>ti-check<?php }?>" data-filter-id="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getId();?>
" 
...
" data-isMine="<?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isMine()||$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->isAdminUser()){?>true<?php }else{ ?>false<?php }?>">
                                                    </span>
                                                     </span>
                                                </div>
                                            </li>
...
'/>
                            <div id="filterActionPopoverHtml">
                                <ul class="listmenu hide" role="menu">
                                    <li role="presentation" class="editFilter">
                                            <a role="menuitem"><i class="ti-pencil"></i>&nbsp;<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a>
                                        </li>
                                    <li role="presentation" class="deleteFilter">
                                            <a role="menuitem"><i class="ti-trash"></i>&nbsp;<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a>
                                    </li>
                                    <li role="presentation" class="duplicateFilter">
                                                <a role="menuitem" ><i class="ti-files"></i>&nbsp;<?php echo vtranslate('LBL_DUPLICATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a>
                                            </li>
                                    <li role="presentation" class="toggleDefault">
                                                <a role="menuitem" >
                                            <i data-check-icon="ti-check-alt" data-uncheck-icon="ti-check"></i>&nbsp;<?php echo vtranslate('LBL_DEFAULT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
                        ...
                        <div class="list-group hide noLists">
                            <h5 class="lists-header"><center> <?php echo vtranslate('LBL_NO');?>
 <?php echo vtranslate('LBL_LISTS');?>
 <?php echo vtranslate('LBL_FOUND');?>
 ... </center></h5>
                        </div>
                   <?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value!='Mine'){?></div><?php }?>	
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if (!empty($_smarty_tpl->tpl_vars['EXTENSION_LINKS']->value)){?>
        <div class="module-filters module-extensions">
            <div class="sidebar-container lists-menu-container">
                <h4 class="sidebar-header"><?php echo vtranslate('LBL_EXTENSIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h4>
                <hr>
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['LINK']->value->isExtensionAccessible()){?>
                                    <li style="font-size:13px;" class="listViewFilter <?php if ($_smarty_tpl->tpl_vars['EXTENSION_MODULE']->value==$_smarty_tpl->tpl_vars['LINK']->value->get('linklabel')){?> active <?php }?>">
