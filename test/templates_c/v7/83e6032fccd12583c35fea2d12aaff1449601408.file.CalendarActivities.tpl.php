<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:24
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Vtiger\dashboards\CalendarActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31475ee9c3c008a2d1-80638551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83e6032fccd12583c35fea2d12aaff1449601408' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Vtiger\\dashboards\\CalendarActivities.tpl',
      1 => 1589643820,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31475ee9c3c008a2d1-80638551',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3c011966',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3c011966')) {function content_5ee9c3c011966($_smarty_tpl) {?>
...
"><?php if (!$_smarty_tpl->tpl_vars['usersList']->value){?><?php echo vtranslate('LBL_MY',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
" <?php if ($_smarty_tpl->tpl_vars['SELECTED']->value==$_smarty_tpl->tpl_vars['CURRENTUSER']->value->getId()){?>selected<?php }?>><?php echo vtranslate('LBL_MINE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</option>
...
"<?php if ($_smarty_tpl->tpl_vars['SELECTED']->value==$_smarty_tpl->tpl_vars['USER_ID']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['USER_NAME']->value;?>
</option>
                <?php } ?>
...
" <?php if ($_smarty_tpl->tpl_vars['SELECTED']->value==$_smarty_tpl->tpl_vars['GROUP_ID']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['GROUP_NAME']->value;?>
</option>
                <?php } ?>
                <option value="all" <?php if ($_smarty_tpl->tpl_vars['SELECTED']->value=="all"){?>selected<?php }?>><?php echo vtranslate('All',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</option>
            </select>
        </div>
    <?php }?>
