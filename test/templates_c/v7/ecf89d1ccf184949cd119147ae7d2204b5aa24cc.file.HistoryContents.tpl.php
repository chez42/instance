<?php /* Smarty version Smarty-3.1.7, created on 2020-06-17 07:18:23
         compiled from "D:\xampp\htdocs\omni-live\layouts\rainbow\modules\Vtiger\dashboards\HistoryContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:72895ee9c3bf366e30-51663081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecf89d1ccf184949cd119147ae7d2204b5aa24cc' => 
    array (
      0 => 'D:\\xampp\\htdocs\\omni-live\\layouts\\rainbow\\modules\\Vtiger\\dashboards\\HistoryContents.tpl',
      1 => 1589643821,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '72895ee9c3bf366e30-51663081',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee9c3bf4e951',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee9c3bf4e951')) {function content_5ee9c3bf4e951($_smarty_tpl) {?>
				...
				<?php if ($_smarty_tpl->tpl_vars['PROCEED']->value){?>
					<div class="row entry clearfix">
						<div class='col-lg-2 col-xs-3 pull-left'>
							...
							<?php }?>
							<?php $_smarty_tpl->tpl_vars['iconsarray'] = new Smarty_variable(array('potentials'=>'attach_money','marketing'=>'thumb_up','leads'=>'thumb_up','accounts'=>'business','sales'=>'attach_money','smsnotifier'=>'sms','services'=>'format_list_bulleted','pricebooks'=>'library_books','salesorder'=>'attach_money','purchaseorder'=>'attach_money','vendors'=>'local_shipping','faq'=>'help','helpdesk'=>'headset','assets'=>'settings','project'=>'card_travel','projecttask'=>'check_box','projectmilestone'=>'card_travel','mailmanager'=>'email','documents'=>'file_download','calendar'=>'event','emails'=>'email','reports'=>'show_chart','servicecontracts'=>'content_paste','contacts'=>'contacts','campaigns'=>'notifications','quotes'=>'description','invoice'=>'description','emailtemplates'=>'subtitles','pbxmanager'=>'perm_phone_msg','rss'=>'rss_feed','recyclebin'=>'delete_forever','products'=>'inbox','portal'=>'web','inventory'=>'assignment','support'=>'headset','tools'=>'business_center','mycthemeswitcher'=>'folder','chat'=>'chat','mobilecall'=>'call','call'=>'call','meeting'=>'people'), null, 0);?>
									
							<span>
							
							<i class=" entryIcon vicon-<?php echo strtolower($_smarty_tpl->tpl_vars['VT_ICON']->value);?>
...
></i>
 ...
 <a class="text-info cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value,'javascript:')===0){?>
...
"><b><?php echo vtranslate('LBL_MORE');?>
							...
							<?php }elseif($_smarty_tpl->tpl_vars['HISTORY']->value->isCreate()){?>
								<div>
									...
									<a class="text-info cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value,'javascript:')===0){?> onclick='<?php echo substr($_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value,strlen("javascript:"));?>
' <?php }else{ ?> onclick='window.location.href="<?php echo $_smarty_tpl->tpl_vars['DETAILVIEW_URL']->value;?>
								...
								<div>
									...
									<?php if ($_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getModuleName()=='Calendar'){?>
										<?php if (isPermitted('Calendar','DetailView',$_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getId())=='yes'){?>
											<a class="text-info cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['LINKED_RECORD_DETAIL_URL']->value,'javascript:')===0){?> onclick='<?php echo substr($_smarty_tpl->tpl_vars['LINKED_RECORD_DETAIL_URL']->value,strlen("javascript:"));?>
'
...
"' <?php }?>><?php echo $_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getName();?>
 ...
 <a class="text-info cursorPointer" <?php if (stripos($_smarty_tpl->tpl_vars['PARENT_DETAIL_URL']->value,'javascript:')===0){?>
...
"' <?php }?>>
					...
					<p class="pull-right muted" style="padding-right:10px;"><span title="<?php echo Vtiger_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['TIME']->value));?>
"><?php echo Vtiger_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['TIME']->value));?>
			...
			<?php }elseif($_smarty_tpl->tpl_vars['MODELNAME']->value=='ModComments_Record_Model'){?>
				<div class="row">
					<div class="col-lg-2 col-xs-3 pull-left">
						<span><i class="material-icons entryIcon" title=<?php echo $_smarty_tpl->tpl_vars['TRANSLATED_MODULE_NAME']->value;?>
>chat</i></span>
					</div>
 ...
 <a class="text-info textOverflowEllipsis" href="<?php echo $_smarty_tpl->tpl_vars['HISTORY']->value->getParentRecordModel()->getDetailViewUrl();?>
...
"><?php echo Vtiger_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['COMMENT_TIME']->value));?>
		...
		<?php if ($_smarty_tpl->tpl_vars['NEXTPAGE']->value){?>
			<div class="row">
				<div class="col-lg-12">
					<h4><a href="javascript:;" class="text-info load-more" data-page="<?php echo $_smarty_tpl->tpl_vars['PAGE']->value;?>
