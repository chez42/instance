...
$config['authentication'] = function () {
    return ( isset($_SESSION['authenticated_user_id']) && $_SESSION['authenticated_user_id'])?true:false;
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'omniscient';
$config['licenseKey']  = '*M?P-*1**-Z**H-*1**-*X**-G*F*-2**N';
